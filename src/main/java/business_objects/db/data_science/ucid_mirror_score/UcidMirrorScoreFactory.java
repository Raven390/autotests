...
public class UcidMirrorScoreFactory {
    ...
    public static UcidMirrorScore generateUcidMirrorScoreObject(ClientHelper client, Double udicScore,
            Double modelScore) {
        return new UcidMirrorScore(client.getUcid(), Utils.getRandomIntPositive().toString(), 1, getTomorrowTimestampDbFormat(), modelScore, 1, 1, udicScore);
    }
