...
public class LoyaltiesRedemptionObject {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(ucid, that.ucid)
                && Objects.equals(loyaltyRedemptionId, that.loyaltyRedemptionId)
    ...
    public String toString() {
        return "LoyaltiesRedemptionObject{" + "ucid='" + ucid + '\'' + ", loyaltiesRedemption=" + loyaltyRedemptionId
                + ", brand='" + brand + '\'' + ", regulator='" + regulator + '\'' + ", user_id='" + user_id + '\''
                + ", rewardId=" + rewardId + ", rewardType=" + rewardType + ", source=" + source + ", point=" + point
                + ", currency='" + currency + '\'' + ", amount=" + amount + ", amountUsd=" + amountUsd + ", status="
                + status + ", extend='" + extend + '\'' + ", createTime='" + createTime + '\'' + ", createTimeUtc='"
                + createTimeUtc + '\'' + ", lastUpdated='" + lastUpdated + '\'' + '}';
    }
}
