...
public class DictIsTestDictActiveTradingDaysByUcidObjectFactory {
    ...
    public static DictActiveTradingDaysByUcidObject generateDictActiveTradingDaysByClient(ClientHelper client) {
        return new DictActiveTradingDaysByUcidObject(
                client.getUcid(), getCurrentDate()
        );
    }

    public static List<DictActiveTradingDaysByUcidObject> generateTradingDaysByClient(ClientHelper client,
            int daysAmount) {
        ...
        for (int i = 0; i < daysAmount; i++) {
            ...
            tradingDays.add(new DictActiveTradingDaysByUcidObject(
                    client.getUcid(), tradeDate
            ));
        }
