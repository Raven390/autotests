...
public class CrmTbWithdrawalObject {
    ...
    public CrmTbWithdrawalObject(Integer sourceIdSt, Integer brandUid, String brand, String regulator, Integer userId,
            ...
            Integer isNonApp, String lastUpdated) {
