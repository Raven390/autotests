...
public class NameBirthTableEntryFactory {
    ...
    public static NameBirthTableEntry nameBirthTableEntryForConnectionSearch(
            ClientHelper client, String name, String lastname, String dateOfBirth) {
        return new NameBirthTableEntry(client.getUcid(), name, lastname, dateOfBirth);
    }
}
