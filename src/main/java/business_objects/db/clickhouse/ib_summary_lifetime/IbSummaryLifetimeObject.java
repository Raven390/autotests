...
public class IbSummaryLifetimeObject {
    ...
    public IbSummaryLifetimeObject(
            ...
            String serverName,
            Integer ibLevel,
            Long masterIbRebateAccount,
            Long ibRebateAccount,
            Integer directUsersCount,
            Integer fraudstersCount,
            Integer subIbsCount,
            Double pnl,
            Double rebate,
            Double netPnl,
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(sourceIdSt, that.sourceIdSt)
                ...
                && Objects.equals(ibLevel, that.ibLevel)
                && Objects.equals(masterIbRebateAccount, that.masterIbRebateAccount)
                && Objects.equals(ibRebateAccount, that.ibRebateAccount)
                && Objects.equals(directUsersCount, that.directUsersCount)
                && Objects.equals(fraudstersCount, that.fraudstersCount)
                && Objects.equals(subIbsCount, that.subIbsCount)
    ...
    public String toString() {
        return "IbSummaryLifetimeObject{" + "sourceIdSt=" + sourceIdSt + ", userId=" + userId + ", brand='" + brand
                + '\'' + ", regulator='" + regulator + '\'' + ", ucid='" + ucid + '\'' + ", serverName='" + serverName
                + '\'' + ", ibLevel=" + ibLevel + ", masterIbRebateAccount=" + masterIbRebateAccount
                + ", ibRebateAccount=" + ibRebateAccount + ", directUsersCount=" + directUsersCount
                + ", fraudstersCount=" + fraudstersCount + ", subIbsCount=" + subIbsCount + ", pnl=" + pnl + ", rebate="
                + rebate + ", netPnl=" + netPnl + ", deposit=" + deposit + ", withdrawal=" + withdrawal
                + ", netDeposit=" + netDeposit + ", equity=" + equity + ", notionalValue=" + notionalValue
