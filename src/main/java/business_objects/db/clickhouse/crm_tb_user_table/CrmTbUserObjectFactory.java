...
public class CrmTbUserObjectFactory {
    ...
    public static CrmTbUserObject generateUserByClient(ClientHelper client) {
        return new CrmTbUserObject(client.getUserId(), client.getUcid(), client.getBrand(), client.getRegulator(), getCurrentDate(), getCurrentDate(), "Test", "User", "1", "1961-02-01", "Cyprus", "CY", "CY", "en", "RUS", "paRP/scRJ89KbGWkZOrJVF/FbLaXR1jx", "OlIoGyRiWyMgmlKyQZkW6w==", "357", "1", "2FA", "2", "1", "2", client.getIbId(), client.getCpaId(), client.getReferrerId(), "PARTIAL_KYC_ID_PASS", getCurrentTimestampDbFormat(), "2025-01-30 14:56:59.000", "2025-01-30 14:56:59.000", getRandomUuidString(), "nationalityId", "2015-11-29 09:55:01");
    }
