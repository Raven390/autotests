...
public class CrmTbUserObject {
    ...
    public boolean equals(Object o) {
        ...
        return userId == that.userId
                ...
                && Objects.equals(registrationDateUtc, that.registrationDateUtc)
                ...
                && Objects.equals(isTwoFaUser, that.isTwoFaUser)
                && Objects.equals(authentication, that.authentication)
                && Objects.equals(websiteUserType, that.websiteUserType)
                ...
                && Objects.equals(poiCompleteTs, that.poiCompleteTs);
    }
    ...
    public String toString() {
        return "CrmTbUserObject{" + "userId=" + userId + ", ucid='" + ucid + '\'' + ", brand='" + brand + '\''
                + ", regulator='" + regulator + '\'' + ", registrationDate='" + registrationDate + '\''
                + ", registrationDateUtc='" + registrationDateUtc + '\'' + ", firstName='" + firstName + '\''
                + ", lastName='" + lastName + '\'' + ", gender='" + gender + '\'' + ", birthday='" + birthday + '\''
                + ", country='" + country + '\'' + ", countryCode='" + countryCode + '\'' + ", isoCountryCode='"
                + isoCountryCode + '\'' + ", language='" + language + '\'' + ", nationality='" + nationality + '\''
                + ", email='" + email + '\'' + ", phoneNum='" + phoneNum + '\'' + ", phoneCountryCode='"
                + phoneCountryCode + '\'' + ", isTwoFaUser='" + isTwoFaUser + '\'' + ", authentication='"
                + authentication + '\'' + ", websiteUserType='" + websiteUserType + '\'' + ", emailVerificationMark='"
                + emailVerificationMark + '\'' + ", phoneVerificationMark='" + phoneVerificationMark + '\'' + ", ibId="
                + ibId + ", cpaId=" + cpaId + ", rafReferrerId=" + rafReferrerId + ", kycStatus='" + kycStatus + '\''
                + ", lastUpdated='" + lastUpdated + '\'' + ", createTime='" + createTime + '\'' + ", createTimeUtc='"
                + createTimeUtc + '\'' + ", nationalityId='" + nationalityId + '\'' + ", poiCompleteTs='"
                + poiCompleteTs + '\'' + '}';
    }
}
