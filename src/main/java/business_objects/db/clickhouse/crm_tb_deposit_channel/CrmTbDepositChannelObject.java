...
public class CrmTbDepositChannelObject {
    ...
    public String toString() {
        return "CrmTbDepositChannelObject{" + "sourceIdSt=" + sourceIdSt + ", id=" + id + ", channelId=" + channelId + ", typeId=" + typeId + ", isMobileChannel=" + isMobileChannel + ", name='" + name + '\'' + ", lastUpdated='" + lastUpdated + '\'' + '}';
    }
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(sourceIdSt, that.sourceIdSt) && Objects.equals(id, that.id) && Objects.equals(channelId, that.channelId) && Objects.equals(typeId, that.typeId) && Objects.equals(isMobileChannel, that.isMobileChannel) && Objects.equals(name, that.name) && Objects.equals(lastUpdated, that.lastUpdated);
    }
