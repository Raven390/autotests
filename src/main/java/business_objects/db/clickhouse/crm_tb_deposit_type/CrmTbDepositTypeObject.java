...
public class CrmTbDepositTypeObject {
    ...
    public String toString() {
        return "CrmTbDepositTypeObject{" + "sourceIdSt=" + sourceIdSt + ", id=" + id + ", category=" + category + ", name='" + name + '\'' + ", lastUpdated='" + lastUpdated + '\'' + '}';
    }
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(sourceIdSt, that.sourceIdSt) && Objects.equals(id, that.id) && Objects.equals(category, that.category) && Objects.equals(name, that.name) && Objects.equals(lastUpdated, that.lastUpdated);
    }
