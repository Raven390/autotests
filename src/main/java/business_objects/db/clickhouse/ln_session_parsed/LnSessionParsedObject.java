...
public class LnSessionParsedObject {
    ...
    private String summaryReasonCodeOriginal;
    ...
    public LnSessionParsedObject(
            ...
            Integer eventId,
            String proxyIp,
            String proxyIpActivities,
            String[] proxyIpAttributes,
            String proxyIpCity,
            String proxyIpConnectionType,
            String proxyIpFirstSeen,
            String proxyIpGeo,
            String proxyIpHome,
            String proxyIpIsp,
            Double proxyIpLatitude,
            Double proxyIpLongitude,
            String proxyIpOrganization,
            String proxyIpOrganizationType,
            String proxyIpPostalCode,
            String proxyIpRegion,
            String proxyIpResult,
            String proxyIpRoutingType,
            Integer proxyIpScore,
            Integer proxyIpWorstScore,
            String proxyIpv6,
            String proxyName,
            Double proxyScore,
            String proxyType,
            String trueIp,
            String trueIpActivities,
            String[] trueIpAttributes,
            String trueIpCity,
            Integer trueIpCountryConfidence,
            String trueIpFirstSeen,
            String trueIpGeo,
            String trueIpIsp,
            String trueIpLastEvent,
            String trueIpOrganization,
            String trueIpOrganizationType,
            String trueIpPostalCode,
            String trueIpRegion,
            String trueIpResult,
            String trueIpRoutingType,
            Integer trueIpScore,
            Integer trueIpWorstScore,
            String trueIpv6,
            Integer vpnScore,
            String summaryReasonCode,
            String os,
            String tmxSummaryReasonCode) {
        this.ucid = ucid;
        this.id = id;
        this.brand = brand;
    ...
    public boolean equals(Object o) {
        ...
        return pluginNumber == that.pluginNumber
                ...
                && Objects.equals(mobileCode, that.mobileCode)
                && Objects.equals(mobile, that.mobile)
                && Objects.equals(eventType, that.eventType)
                && Objects.equals(isFromApp, that.isFromApp)
                ...
                && Objects.equals(accountAddressActivities, that.accountAddressActivities)
                && Objects.deepEquals(accountAddressAttributes, that.accountAddressAttributes)
                && Objects.equals(accountAddressCity, that.accountAddressCity)
                && Objects.equals(accountAddressCountry, that.accountAddressCountry)
                && Objects.equals(accountAddressFirstSeen, that.accountAddressFirstSeen)
                && Objects.equals(accountAddressResult, that.accountAddressResult)
                && Objects.equals(accountAddressScore, that.accountAddressScore)
                && Objects.equals(accountAddressState, that.accountAddressState)
                && Objects.equals(accountAddressStreet1, that.accountAddressStreet1)
                && Objects.equals(accountAddressWorstScore, that.accountAddressWorstScore)
                && Objects.equals(accountAddressZip, that.accountAddressZip)
                && Objects.equals(accountDateOfBirth, that.accountDateOfBirth)
                && Objects.equals(accountEmail, that.accountEmail)
                && Objects.equals(accountEmailActivities, that.accountEmailActivities)
                && Objects.deepEquals(accountEmailAttributes, that.accountEmailAttributes)
                && Objects.equals(accountEmailDomain, that.accountEmailDomain)
                && Objects.equals(accountEmailFirstSeen, that.accountEmailFirstSeen)
                && Objects.equals(accountEmailResult, that.accountEmailResult)
                && Objects.equals(accountEmailScore, that.accountEmailScore)
                && Objects.equals(accountEmailWorstScore, that.accountEmailWorstScore)
                && Objects.equals(accountFirstName, that.accountFirstName)
                && Objects.equals(accountGender, that.accountGender)
                && Objects.equals(accountLastName, that.accountLastName)
                && Objects.equals(accountLexIdActivities, that.accountLexIdActivities)
                && Objects.deepEquals(accountLexIdAttributes, that.accountLexIdAttributes)
                && Objects.equals(accountLexIdFirstSeen, that.accountLexIdFirstSeen)
                && Objects.equals(accountLexIdNumber, that.accountLexIdNumber)
                && Objects.equals(accountLexIdResult, that.accountLexIdResult)
                && Objects.equals(accountLexIdScore, that.accountLexIdScore)
                && Objects.equals(accountLexIdWorstScore, that.accountLexIdWorstScore)
                && Objects.equals(accountLogin, that.accountLogin)
                && Objects.equals(accountLoginActivities, that.accountLoginActivities)
                && Objects.deepEquals(accountLoginAttributes, that.accountLoginAttributes)
                && Objects.equals(accountLoginFirstSeen, that.accountLoginFirstSeen)
                && Objects.equals(accountLoginResult, that.accountLoginResult)
                && Objects.equals(accountLoginScore, that.accountLoginScore)
                && Objects.equals(accountLoginWorstScore, that.accountLoginWorstScore)
                && Objects.equals(accountName, that.accountName)
                && Objects.equals(accountNameActivities, that.accountNameActivities)
                && Objects.deepEquals(accountNameAttributes, that.accountNameAttributes)
                && Objects.equals(accountNameFirstSeen, that.accountNameFirstSeen)
                && Objects.equals(accountNameResult, that.accountNameResult)
                && Objects.equals(accountNameScore, that.accountNameScore)
                && Objects.equals(accountNameWorstScore, that.accountNameWorstScore)
                && Objects.equals(accountTelephone, that.accountTelephone)
                && Objects.equals(accountTelephoneActivities, that.accountTelephoneActivities)
                && Objects.deepEquals(accountTelephoneAttributes, that.accountTelephoneAttributes)
                && Objects.equals(accountTelephoneCountryCode, that.accountTelephoneCountryCode)
                && Objects.equals(accountTelephoneFirstSeen, that.accountTelephoneFirstSeen)
                && Objects.equals(accountTelephoneGeo, that.accountTelephoneGeo)
                && Objects.equals(accountTelephoneIsPossible, that.accountTelephoneIsPossible)
                && Objects.equals(accountTelephoneIsValid, that.accountTelephoneIsValid)
                && Objects.equals(accountTelephoneResult, that.accountTelephoneResult)
                && Objects.equals(accountTelephoneScore, that.accountTelephoneScore)
                && Objects.equals(accountTelephoneType, that.accountTelephoneType)
                && Objects.equals(accountTelephoneWorstScore, that.accountTelephoneWorstScore)
                && Objects.equals(agentBssidActivities, that.agentBssidActivities)
                && Objects.deepEquals(agentBssidAttributes, that.agentBssidAttributes)
                && Objects.equals(agentBssidFirstSeen, that.agentBssidFirstSeen)
                && Objects.equals(agentBssidResult, that.agentBssidResult)
                && Objects.equals(agentBssidScore, that.agentBssidScore)
                && Objects.equals(agentBssidWorstScore, that.agentBssidWorstScore)
                && Objects.equals(agentSsidClear, that.agentSsidClear)
                && Objects.equals(appIntegrityScore, that.appIntegrityScore)
                && Objects.equals(audioContext, that.audioContext)
                && Objects.equals(batteryStatusLevel, that.batteryStatusLevel)
                && Objects.equals(batteryStatus, that.batteryStatus)
                && Objects.equals(bbAnomalyRating, that.bbAnomalyRating)
                && Objects.deepEquals(bbAnomalyReasonCode, that.bbAnomalyReasonCode)
                && Objects.equals(bbAnomalyScore, that.bbAnomalyScore)
                && Objects.equals(bbAssessment, that.bbAssessment)
                && Objects.equals(bbAssessmentRating, that.bbAssessmentRating)
                && Objects.equals(bbAuthConfidenceScore, that.bbAuthConfidenceScore)
                && Objects.equals(bbAuthHistoricalScoreMean, that.bbAuthHistoricalScoreMean)
                && Objects.equals(bbAuthHistoricalScoreStd, that.bbAuthHistoricalScoreStd)
                && Objects.equals(bbAuthScore, that.bbAuthScore)
                && Objects.equals(bbBotRating, that.bbBotRating)
                && Objects.equals(bbBotScore, that.bbBotScore)
                && Objects.equals(bbFraudRating, that.bbFraudRating)
                && Objects.equals(bbFraudScore, that.bbFraudScore)
                && Objects.deepEquals(behaviosecBotReasons, that.behaviosecBotReasons)
                && Objects.equals(behaviosecConfidence, that.behaviosecConfidence)
                && Objects.deepEquals(behaviosecDataIntegrityReasons, that.behaviosecDataIntegrityReasons)
                && Objects.equals(
                        behaviosecPopulationProfileChallengerRiskRank,
                        that.behaviosecPopulationProfileChallengerRiskRank)
                && Objects.equals(
                        behaviosecPopulationProfileChallengerScore, that.behaviosecPopulationProfileChallengerScore)
                && Objects.equals(behaviosecPopulationProfileRiskRank, that.behaviosecPopulationProfileRiskRank)
                && Objects.equals(behaviosecPopulationProfileScore, that.behaviosecPopulationProfileScore)
                && Objects.equals(behaviosecScore, that.behaviosecScore)
                && Objects.equals(behaviosecUserid, that.behaviosecUserid)
                && Objects.equals(browser, that.browser)
                && Objects.equals(browserVersion, that.browserVersion)
                && Objects.equals(browserAddon, that.browserAddon)
                && Objects.equals(browserAddonHash, that.browserAddonHash)
                && Objects.equals(browserAnomaly, that.browserAnomaly)
                && Objects.equals(browserLanguage, that.browserLanguage)
                && Objects.equals(browserSpoofRating, that.browserSpoofRating)
                && Objects.equals(browserStringHash, that.browserStringHash)
                && Objects.equals(browserString, that.browserString)
                && Objects.equals(profiledUrl, that.profiledUrl)
                && Objects.equals(canvasHash, that.canvasHash)
                && Objects.equals(cidrNumber, that.cidrNumber)
                && Objects.equals(deviceActivities, that.deviceActivities)
                && Objects.deepEquals(deviceAttributes, that.deviceAttributes)
                && Objects.equals(deviceFingerprint, that.deviceFingerprint)
                && Objects.equals(deviceFingerprintActivities, that.deviceFingerprintActivities)
                && Objects.deepEquals(deviceFingerprintAttributes, that.deviceFingerprintAttributes)
                && Objects.equals(deviceFingerprintFirstSeen, that.deviceFingerprintFirstSeen)
                && Objects.equals(deviceFingerprintResult, that.deviceFingerprintResult)
                && Objects.equals(deviceFingerprintScore, that.deviceFingerprintScore)
                && Objects.equals(deviceFingerprintWorstScore, that.deviceFingerprintWorstScore)
                && Objects.equals(deviceFirstSeen, that.deviceFirstSeen)
                && Objects.deepEquals(deviceHealthReasons, that.deviceHealthReasons)
                && Objects.equals(deviceId, that.deviceId)
                && Objects.equals(deviceIdConfidence, that.deviceIdConfidence)
                && Objects.equals(deviceMemory, that.deviceMemory)
                && Objects.equals(deviceModel, that.deviceModel)
                && Objects.equals(deviceName, that.deviceName)
                && Objects.equals(agentLanguage, that.agentLanguage)
                && Objects.equals(deviceResult, that.deviceResult)
                && Objects.equals(deviceScore, that.deviceScore)
                && Objects.equals(deviceWorstScore, that.deviceWorstScore)
                && Objects.equals(digitalId, that.digitalId)
                && Objects.equals(digitalIdActivities, that.digitalIdActivities)
                && Objects.deepEquals(digitalIdAttributes, that.digitalIdAttributes)
                && Objects.equals(digitalIdConfidence, that.digitalIdConfidence)
                && Objects.equals(digitalIdConfidenceRating, that.digitalIdConfidenceRating)
                && Objects.equals(digitalIdFirstSeen, that.digitalIdFirstSeen)
                && Objects.equals(digitalIdReasonCode, that.digitalIdReasonCode)
                && Objects.equals(digitalIdResult, that.digitalIdResult)
                && Objects.equals(digitalIdTrustScore, that.digitalIdTrustScore)
                && Objects.equals(digitalIdTrustScoreRating, that.digitalIdTrustScoreRating)
                && Objects.deepEquals(digitalIdTrustScoreReasonCode, that.digitalIdTrustScoreReasonCode)
                && Objects.deepEquals(digitalIdTrustScoreSummaryReasonCode, that.digitalIdTrustScoreSummaryReasonCode)
                && Objects.equals(dnsIp, that.dnsIp)
                && Objects.deepEquals(dnsIpAttributes, that.dnsIpAttributes)
                && Objects.equals(dnsIpCity, that.dnsIpCity)
                && Objects.equals(dnsIpGeo, that.dnsIpGeo)
                && Objects.equals(dnsIpIsp, that.dnsIpIsp)
                && Objects.equals(dnsIpOrganization, that.dnsIpOrganization)
                && Objects.equals(dnsIpPostalCode, that.dnsIpPostalCode)
                && Objects.equals(dnsIpRegion, that.dnsIpRegion)
                && Objects.equals(emailageEmailriskscoreEaadvice, that.emailageEmailriskscoreEaadvice)
                && Objects.equals(emailageEmailriskscoreEareason, that.emailageEmailriskscoreEareason)
                && Objects.equals(emailageEmailriskscoreEascore, that.emailageEmailriskscoreEascore)
                && Objects.equals(emailageEmailriskscoreEariskbandid, that.emailageEmailriskscoreEariskbandid)
                && Objects.equals(emailageEmailriskscoreEmailCreationDays, that.emailageEmailriskscoreEmailCreationDays)
                && Objects.equals(emailageEmailriskscoreEmailage, that.emailageEmailriskscoreEmailage)
                && Objects.equals(emailageEmailriskscorePhonecarriertype, that.emailageEmailriskscorePhonecarriertype)
                && Objects.equals(emailageEmailriskscorePhoneownermatch, that.emailageEmailriskscorePhoneownermatch)
                && Objects.equals(
                        emailageEmailriskscorePhonetofullnameconfidence,
                        that.emailageEmailriskscorePhonetofullnameconfidence)
                && Objects.equals(
                        emailageEmailriskscorePhonetolastnameconfidence,
                        that.emailageEmailriskscorePhonetolastnameconfidence)
                && Objects.equals(emailageEmailriskscoreIpRisklevel, that.emailageEmailriskscoreIpRisklevel)
                && Objects.equals(emailageEmailriskscoreIpRiskreason, that.emailageEmailriskscoreIpRiskreason)
                && Objects.equals(emailageEmailriskscore, that.emailageEmailriskscore)
                && Objects.equals(emailageEmailriskscoreDomainrisklevel, that.emailageEmailriskscoreDomainrisklevel)
                && Objects.equals(
                        emailageEmailriskscoreDomainCreationDays, that.emailageEmailriskscoreDomainCreationDays)
                && Objects.equals(emailageEmailriskscoreDomainage, that.emailageEmailriskscoreDomainage)
                && Objects.equals(emailageEmailriskscoreDomainexists, that.emailageEmailriskscoreDomainexists)
                && Objects.equals(emailageEmailriskscoreDomaincountry, that.emailageEmailriskscoreDomaincountry)
                && Objects.equals(emailageEmailriskscoreDomaincompany, that.emailageEmailriskscoreDomaincompany)
                && Objects.equals(emailageEmailriskscoreDomainname, that.emailageEmailriskscoreDomainname)
                && Objects.equals(emailageEmailriskscoreDomaincategory, that.emailageEmailriskscoreDomaincategory)
                && Objects.equals(
                        emailageEmailriskscoreOveralldigitalidentityscore,
                        that.emailageEmailriskscoreOveralldigitalidentityscore)
                && Objects.equals(emailageEmailriskscoreDisdescription, that.emailageEmailriskscoreDisdescription)
                && Objects.equals(eventDatetime, that.eventDatetime)
                && Objects.equals(eventId, that.eventId)
                && Objects.equals(finalReviewStatus, that.finalReviewStatus)
                && Objects.deepEquals(fuzzyDeviceAttributes, that.fuzzyDeviceAttributes)
                && Objects.equals(fuzzyDeviceFirstSeen, that.fuzzyDeviceFirstSeen)
                && Objects.equals(fuzzyDeviceId, that.fuzzyDeviceId)
                && Objects.equals(fuzzyDeviceIdConfidence, that.fuzzyDeviceIdConfidence)
                && Objects.equals(fuzzyDeviceMatchResult, that.fuzzyDeviceMatchResult)
                && Objects.equals(fuzzyDeviceResult, that.fuzzyDeviceResult)
                && Objects.equals(fuzzyDeviceScore, that.fuzzyDeviceScore)
                && Objects.equals(fuzzyDeviceWorstScore, that.fuzzyDeviceWorstScore)
                && Objects.equals(geofenceCountryGps, that.geofenceCountryGps)
                && Objects.equals(geofenceRegionGps, that.geofenceRegionGps)
                && Objects.equals(gpsSpoof, that.gpsSpoof)
                && Objects.equals(gpuName, that.gpuName)
                && Objects.equals(gpuVendor, that.gpuVendor)
                && Objects.equals(hwFingerprint, that.hwFingerprint)
                && Objects.equals(jbRoot, that.jbRoot)
                && Objects.equals(jsBrowser, that.jsBrowser)
                && Objects.equals(jsBrowserStringHash, that.jsBrowserStringHash)
                && Objects.equals(jsFontsHash, that.jsFontsHash)
                && Objects.equals(jsFontsNumber, that.jsFontsNumber)
                && Objects.equals(jsOs, that.jsOs)
                && Objects.equals(liveness, that.liveness)
                && Objects.equals(macAddress, that.macAddress)
                && Objects.equals(mathRoutine, that.mathRoutine)
                && Objects.equals(mimeTypeHash, that.mimeTypeHash)
                && Objects.equals(multiDisplay, that.multiDisplay)
                && Objects.equals(nationalId, that.nationalId)
                && Objects.equals(passwordHash, that.passwordHash)
                && Objects.equals(passwordHashActivities, that.passwordHashActivities)
                && Objects.deepEquals(passwordHashAttributes, that.passwordHashAttributes)
                && Objects.equals(passwordHashFirstSeen, that.passwordHashFirstSeen)
                && Objects.equals(passwordHashResult, that.passwordHashResult)
                && Objects.equals(passwordHashScore, that.passwordHashScore)
                && Objects.equals(passwordHashWorstScore, that.passwordHashWorstScore)
                && Objects.equals(policy, that.policy)
                && Objects.equals(privateBrowsing, that.privateBrowsing)
                && Objects.equals(proxyIp, that.proxyIp)
                && Objects.equals(proxyIpActivities, that.proxyIpActivities)
                && Objects.deepEquals(proxyIpAttributes, that.proxyIpAttributes)
                && Objects.equals(proxyIpCity, that.proxyIpCity)
                && Objects.equals(proxyIpConnectionType, that.proxyIpConnectionType)
                && Objects.equals(proxyIpFirstSeen, that.proxyIpFirstSeen)
                && Objects.equals(proxyIpGeo, that.proxyIpGeo)
                && Objects.equals(proxyIpHome, that.proxyIpHome)
                && Objects.equals(proxyIpIsp, that.proxyIpIsp)
                && Objects.equals(proxyIpLatitude, that.proxyIpLatitude)
                && Objects.equals(proxyIpLongitude, that.proxyIpLongitude)
                && Objects.equals(proxyIpOrganization, that.proxyIpOrganization)
                && Objects.equals(proxyIpOrganizationType, that.proxyIpOrganizationType)
                && Objects.equals(proxyIpPostalCode, that.proxyIpPostalCode)
                && Objects.equals(proxyIpRegion, that.proxyIpRegion)
                && Objects.equals(proxyIpResult, that.proxyIpResult)
                && Objects.equals(proxyIpRoutingType, that.proxyIpRoutingType)
                && Objects.equals(proxyIpScore, that.proxyIpScore)
                && Objects.equals(proxyIpWorstScore, that.proxyIpWorstScore)
                && Objects.equals(proxyIpv6, that.proxyIpv6)
                && Objects.equals(proxyName, that.proxyName)
                && Objects.equals(proxyScore, that.proxyScore)
                && Objects.equals(proxyType, that.proxyType)
                && Objects.equals(relatedRequestId, that.relatedRequestId)
                && Objects.equals(remoteAccess, that.remoteAccess)
                && Objects.equals(remoteAccessRating, that.remoteAccessRating)
                && Objects.equals(remoteAccessScore, that.remoteAccessScore)
                && Objects.equals(remoteDesktop, that.remoteDesktop)
                && Objects.equals(screenRes, that.screenRes)
                && Objects.equals(screenResAnomaly, that.screenResAnomaly)
                && Objects.equals(screenResZoom, that.screenResZoom)
                && Objects.equals(seRating, that.seRating)
                && Objects.equals(seScore, that.seScore)
                && Objects.equals(smartLearningFraudRating, that.smartLearningFraudRating)
                && Objects.equals(smartLearningPScore, that.smartLearningPScore)
                && Objects.equals(smartLearningPolicyScore, that.smartLearningPolicyScore)
                && Objects.equals(smartLearningReasonCode, that.smartLearningReasonCode)
                && Objects.equals(smartLearningRiskRank, that.smartLearningRiskRank)
                && Objects.equals(smartLearningSummaryReasonCode, that.smartLearningSummaryReasonCode)
                && Objects.equals(timeZone, that.timeZone)
                && Objects.equals(timeZoneDstOffset, that.timeZoneDstOffset)
                && Objects.equals(timezoneName, that.timezoneName)
                && Objects.equals(timezoneOffsetAnomaly, that.timezoneOffsetAnomaly)
                && Objects.equals(tmxPolicyScore, that.tmxPolicyScore)
                && Objects.equals(tmxRiskRating, that.tmxRiskRating)
                && Objects.equals(tmxVariables, that.tmxVariables)
                && Objects.equals(trueIp, that.trueIp)
                && Objects.equals(trueIpActivities, that.trueIpActivities)
                && Objects.deepEquals(trueIpAttributes, that.trueIpAttributes)
                && Objects.equals(trueIpCity, that.trueIpCity)
                && Objects.equals(trueIpCountryConfidence, that.trueIpCountryConfidence)
                && Objects.equals(trueIpFirstSeen, that.trueIpFirstSeen)
                && Objects.equals(trueIpGeo, that.trueIpGeo)
                && Objects.equals(trueIpIsp, that.trueIpIsp)
                && Objects.equals(trueIpLastEvent, that.trueIpLastEvent)
                && Objects.equals(trueIpOrganization, that.trueIpOrganization)
                && Objects.equals(trueIpOrganizationType, that.trueIpOrganizationType)
                && Objects.equals(trueIpPostalCode, that.trueIpPostalCode)
                && Objects.equals(trueIpRegion, that.trueIpRegion)
                && Objects.equals(trueIpResult, that.trueIpResult)
                && Objects.equals(trueIpConnectionType, that.trueIpConnectionType)
                && Objects.equals(trueIpRoutingType, that.trueIpRoutingType)
                && Objects.equals(trueIpScore, that.trueIpScore)
                && Objects.equals(trueIpWorstScore, that.trueIpWorstScore)
                && Objects.equals(trueIpv6, that.trueIpv6)
                && Objects.equals(uaAgent, that.uaAgent)
                && Objects.equals(uaMobile, that.uaMobile)
                && Objects.equals(unknownSession, that.unknownSession)
                && Objects.equals(virtualDevice, that.virtualDevice)
                && Objects.equals(virtualDeviceReason, that.virtualDeviceReason)
                && Objects.equals(vpnReason, that.vpnReason)
                && Objects.equals(vpnScore, that.vpnScore)
                && Objects.equals(webglHash, that.webglHash)
                && Objects.equals(webrtcExternalIp, that.webrtcExternalIp)
                && Objects.equals(customerEventType, that.customerEventType)
                && Objects.equals(inputIpAddress, that.inputIpAddress)
                && Objects.equals(inputIpIsp, that.inputIpIsp)
                && Objects.equals(inputIpCity, that.inputIpCity)
                && Objects.equals(inputIpRegion, that.inputIpRegion)
                && Objects.equals(inputIpGeo, that.inputIpGeo)
                && Objects.equals(inputIpRoutingType, that.inputIpRoutingType)
                && Objects.equals(webSessionId, that.webSessionId)
                && Objects.equals(conditionAttrib5, that.conditionAttrib5)
                && Objects.equals(agentBrand, that.agentBrand)
                && Objects.equals(agentModel, that.agentModel)
                && Objects.equals(applicationName, that.applicationName)
                && Objects.equals(transactionId, that.transactionId)
                && Objects.equals(lineOfBusiness, that.lineOfBusiness)
                && Objects.equals(accountAddressStreet2, that.accountAddressStreet2)
                && Objects.equals(conditionAttrib1, that.conditionAttrib1)
                && Objects.equals(conditionAttrib2, that.conditionAttrib2)
                && Objects.equals(customCount1, that.customCount1)
                && Objects.equals(localAttrib1, that.localAttrib1)
                && Objects.equals(customCount4, that.customCount4)
                && Objects.equals(conditionAttrib6, that.conditionAttrib6)
                && Objects.equals(conditionAttrib3, that.conditionAttrib3)
                && Objects.equals(primaryAccountBalanceUsd, that.primaryAccountBalanceUsd)
                && Objects.equals(primaryAccountBalance, that.primaryAccountBalance)
                && Objects.equals(primaryAccountBalanceCurrency, that.primaryAccountBalanceCurrency)
                && Objects.equals(conditionAttrib10, that.conditionAttrib10)
                && Objects.equals(conditionAttrib9, that.conditionAttrib9)
                && Objects.equals(conditionAttrib4, that.conditionAttrib4)
                && Objects.equals(conditionAttrib7, that.conditionAttrib7)
                && Objects.equals(conditionAttrib8, that.conditionAttrib8)
                && Objects.equals(localAttrib12, that.localAttrib12)
                && Objects.equals(localAttrib13, that.localAttrib13)
                && Objects.equals(localAttrib14, that.localAttrib14)
                && Objects.equals(localAttrib15, that.localAttrib15)
                && Objects.equals(customCount2, that.customCount2)
                && Objects.equals(customCount13, that.customCount13)
                && Objects.equals(summaryReasonCode, that.summaryReasonCode)
                && Objects.equals(os, that.os)
                && Objects.equals(osVersion, that.osVersion)
                && Objects.equals(tmxSummaryReasonCode, that.tmxSummaryReasonCode)
                && Objects.equals(lastUpdated, that.lastUpdated)
                && Objects.equals(summaryReasonCodeOriginal, that.summaryReasonCodeOriginal);
    }
    ...
    public int hashCode() {
        return Objects.hash(
                ...
                requestResult,
                accountAddress,
                accountAddressActivities,
                Arrays.hashCode(accountAddressAttributes),
                accountAddressCity,
                accountAddressCountry,
                accountAddressFirstSeen,
                accountAddressResult,
                accountAddressScore,
                accountAddressState,
                accountAddressStreet1,
                accountAddressWorstScore,
                accountAddressZip,
                accountDateOfBirth,
                accountEmail,
                accountEmailActivities,
                Arrays.hashCode(accountEmailAttributes),
                accountEmailDomain,
                ...
                accountGender,
                accountLastName,
                accountLexIdActivities,
                Arrays.hashCode(accountLexIdAttributes),
                accountLexIdFirstSeen,
                accountLexIdNumber,
                accountLexIdResult,
                accountLexIdScore,
                accountLexIdWorstScore,
                accountLogin,
                accountLoginActivities,
                Arrays.hashCode(accountLoginAttributes),
                accountLoginFirstSeen,
                accountLoginResult,
                accountLoginScore,
                accountLoginWorstScore,
                accountName,
                accountNameActivities,
                Arrays.hashCode(accountNameAttributes),
                accountNameFirstSeen,
                accountNameResult,
                accountNameScore,
                accountNameWorstScore,
                accountTelephone,
                accountTelephoneActivities,
                Arrays.hashCode(accountTelephoneAttributes),
                accountTelephoneCountryCode,
                accountTelephoneFirstSeen,
                accountTelephoneGeo,
                accountTelephoneIsPossible,
                accountTelephoneIsValid,
                accountTelephoneResult,
                accountTelephoneScore,
                accountTelephoneType,
                accountTelephoneWorstScore,
                agentBssidActivities,
                Arrays.hashCode(agentBssidAttributes),
                agentBssidFirstSeen,
                agentBssidResult,
                agentBssidScore,
                agentBssidWorstScore,
                agentSsidClear,
                appIntegrityScore,
                audioContext,
                batteryStatusLevel,
                ...
                bbAssessment,
                bbAssessmentRating,
                bbAuthConfidenceScore,
                bbAuthHistoricalScoreMean,
                bbAuthHistoricalScoreStd,
                bbAuthScore,
                bbBotRating,
                bbBotScore,
                bbFraudRating,
                bbFraudScore,
                Arrays.hashCode(behaviosecBotReasons),
                behaviosecConfidence,
                Arrays.hashCode(behaviosecDataIntegrityReasons),
                behaviosecPopulationProfileChallengerRiskRank,
                behaviosecPopulationProfileChallengerScore,
                behaviosecPopulationProfileRiskRank,
                ...
                cidrNumber,
                deviceActivities,
                Arrays.hashCode(deviceAttributes),
                deviceFingerprint,
                deviceFingerprintActivities,
                Arrays.hashCode(deviceFingerprintAttributes),
                deviceFingerprintFirstSeen,
                deviceFingerprintResult,
                deviceFingerprintScore,
                deviceFingerprintWorstScore,
                deviceFirstSeen,
                Arrays.hashCode(deviceHealthReasons),
                deviceId,
                deviceIdConfidence,
                deviceMemory,
                deviceModel,
                ...
                digitalId,
                digitalIdActivities,
                Arrays.hashCode(digitalIdAttributes),
                digitalIdConfidence,
                digitalIdConfidenceRating,
                digitalIdFirstSeen,
                digitalIdReasonCode,
                digitalIdResult,
                digitalIdTrustScore,
                digitalIdTrustScoreRating,
                Arrays.hashCode(digitalIdTrustScoreReasonCode),
                Arrays.hashCode(digitalIdTrustScoreSummaryReasonCode),
                dnsIp,
                Arrays.hashCode(dnsIpAttributes),
                dnsIpCity,
                dnsIpGeo,
                dnsIpIsp,
                dnsIpOrganization,
                dnsIpPostalCode,
                dnsIpRegion,
                emailageEmailriskscoreEaadvice,
                emailageEmailriskscoreEareason,
                emailageEmailriskscoreEascore,
                emailageEmailriskscoreEariskbandid,
                emailageEmailriskscoreEmailCreationDays,
                emailageEmailriskscoreEmailage,
                emailageEmailriskscorePhonecarriertype,
                emailageEmailriskscorePhoneownermatch,
                emailageEmailriskscorePhonetofullnameconfidence,
                emailageEmailriskscorePhonetolastnameconfidence,
                emailageEmailriskscoreIpRisklevel,
                emailageEmailriskscoreIpRiskreason,
                emailageEmailriskscore,
                emailageEmailriskscoreDomainrisklevel,
                emailageEmailriskscoreDomainCreationDays,
                emailageEmailriskscoreDomainage,
                emailageEmailriskscoreDomainexists,
                emailageEmailriskscoreDomaincountry,
                emailageEmailriskscoreDomaincompany,
                emailageEmailriskscoreDomainname,
                emailageEmailriskscoreDomaincategory,
                emailageEmailriskscoreOveralldigitalidentityscore,
                emailageEmailriskscoreDisdescription,
                eventDatetime,
                eventId,
                finalReviewStatus,
                Arrays.hashCode(fuzzyDeviceAttributes),
                ...
                nationalId,
                passwordHash,
                passwordHashActivities,
                Arrays.hashCode(passwordHashAttributes),
                passwordHashFirstSeen,
                passwordHashResult,
                passwordHashScore,
                passwordHashWorstScore,
                policy,
                privateBrowsing,
                proxyIp,
                proxyIpActivities,
                Arrays.hashCode(proxyIpAttributes),
                proxyIpCity,
                proxyIpConnectionType,
                proxyIpFirstSeen,
                proxyIpGeo,
                proxyIpHome,
                proxyIpIsp,
                ...
                seRating,
                seScore,
                smartLearningFraudRating,
                smartLearningPScore,
                smartLearningPolicyScore,
                smartLearningReasonCode,
                smartLearningRiskRank,
                smartLearningSummaryReasonCode,
                timeZone,
                timeZoneDstOffset,
                timezoneName,
                timezoneOffsetAnomaly,
                tmxPolicyScore,
                tmxRiskRating,
                tmxVariables,
                trueIp,
                trueIpActivities,
                Arrays.hashCode(trueIpAttributes),
                trueIpCity,
                trueIpCountryConfidence,
                trueIpFirstSeen,
                trueIpGeo,
                trueIpIsp,
                trueIpLastEvent,
                trueIpOrganization,
                trueIpOrganizationType,
                trueIpPostalCode,
                trueIpRegion,
                trueIpResult,
                ...
                conditionAttrib6,
                conditionAttrib3,
                primaryAccountBalanceUsd,
                primaryAccountBalance,
                primaryAccountBalanceCurrency,
                conditionAttrib10,
                conditionAttrib9,
                conditionAttrib4,
                conditionAttrib7,
                ...
                lastUpdated,
                summaryReasonCodeOriginal);
    }

    @Override
    public String toString() {
        return "LnSessionParsedObject{" + "ucid='" + ucid + '\'' + ", id=" + id + ", brand='" + brand + '\''
                + ", sessionId='" + sessionId + '\'' + ", userId=" + userId + ", email='" + email + '\''
                + ", mobileCode=" + mobileCode + ", mobile='" + mobile + '\'' + ", eventType='" + eventType + '\''
                + ", isFromApp=" + isFromApp + ", createTime='" + createTime + '\'' + ", policyScore=" + policyScore
                + ", riskRating='" + riskRating + '\'' + ", reviewStatus='" + reviewStatus + '\'' + ", requestResult='"
                + requestResult + '\'' + ", accountAddress='" + accountAddress + '\'' + ", accountAddressActivities='"
                + accountAddressActivities + '\'' + ", accountAddressAttributes="
                + Arrays.toString(accountAddressAttributes) + ", accountAddressCity='" + accountAddressCity + '\''
                + ", accountAddressCountry='" + accountAddressCountry + '\'' + ", accountAddressFirstSeen='"
                + accountAddressFirstSeen + '\'' + ", accountAddressResult='" + accountAddressResult + '\''
                + ", accountAddressScore=" + accountAddressScore + ", accountAddressState='" + accountAddressState
                + '\'' + ", accountAddressStreet1='" + accountAddressStreet1 + '\'' + ", accountAddressWorstScore="
                + accountAddressWorstScore + ", accountAddressZip='" + accountAddressZip + '\''
                + ", accountDateOfBirth='" + accountDateOfBirth + '\'' + ", accountEmail='" + accountEmail + '\''
                + ", accountEmailActivities='" + accountEmailActivities + '\'' + ", accountEmailAttributes="
                + Arrays.toString(accountEmailAttributes) + ", accountEmailDomain='" + accountEmailDomain + '\''
                + ", accountEmailFirstSeen='" + accountEmailFirstSeen + '\'' + ", accountEmailResult='"
                + accountEmailResult + '\'' + ", accountEmailScore=" + accountEmailScore + ", accountEmailWorstScore="
                + accountEmailWorstScore + ", accountFirstName='" + accountFirstName + '\'' + ", accountGender='"
                + accountGender + '\'' + ", accountLastName='" + accountLastName + '\'' + ", accountLexIdActivities='"
                + accountLexIdActivities + '\'' + ", accountLexIdAttributes=" + Arrays.toString(accountLexIdAttributes)
                + ", accountLexIdFirstSeen='" + accountLexIdFirstSeen + '\'' + ", accountLexIdNumber='"
                + accountLexIdNumber + '\'' + ", accountLexIdResult='" + accountLexIdResult + '\''
                + ", accountLexIdScore=" + accountLexIdScore + ", accountLexIdWorstScore=" + accountLexIdWorstScore
                + ", accountLogin='" + accountLogin + '\'' + ", accountLoginActivities='" + accountLoginActivities
                + '\'' + ", accountLoginAttributes=" + Arrays.toString(accountLoginAttributes)
                + ", accountLoginFirstSeen='" + accountLoginFirstSeen + '\'' + ", accountLoginResult='"
                + accountLoginResult + '\'' + ", accountLoginScore=" + accountLoginScore + ", accountLoginWorstScore="
                + accountLoginWorstScore + ", accountName='" + accountName + '\'' + ", accountNameActivities='"
                + accountNameActivities + '\'' + ", accountNameAttributes=" + Arrays.toString(accountNameAttributes)
                + ", accountNameFirstSeen='" + accountNameFirstSeen + '\'' + ", accountNameResult='" + accountNameResult
                + '\'' + ", accountNameScore=" + accountNameScore + ", accountNameWorstScore=" + accountNameWorstScore
                + ", accountTelephone='" + accountTelephone + '\'' + ", accountTelephoneActivities='"
                + accountTelephoneActivities + '\'' + ", accountTelephoneAttributes="
                + Arrays.toString(accountTelephoneAttributes) + ", accountTelephoneCountryCode="
                + accountTelephoneCountryCode + ", accountTelephoneFirstSeen='" + accountTelephoneFirstSeen + '\''
                + ", accountTelephoneGeo='" + accountTelephoneGeo + '\'' + ", accountTelephoneIsPossible='"
                + accountTelephoneIsPossible + '\'' + ", accountTelephoneIsValid='" + accountTelephoneIsValid + '\''
                + ", accountTelephoneResult='" + accountTelephoneResult + '\'' + ", accountTelephoneScore="
                ...
                + agentBssidActivities + '\'' + ", agentBssidAttributes=" + Arrays.toString(agentBssidAttributes)
                + ", agentBssidFirstSeen='" + agentBssidFirstSeen + '\'' + ", agentBssidResult='" + agentBssidResult
                + '\'' + ", agentBssidScore=" + agentBssidScore + ", agentBssidWorstScore=" + agentBssidWorstScore
                + ", agentSsidClear='" + agentSsidClear + '\'' + ", appIntegrityScore=" + appIntegrityScore
                + ", audioContext='" + audioContext + '\'' + ", batteryStatusLevel=" + batteryStatusLevel
                + ", batteryStatus='" + batteryStatus + '\'' + ", bbAnomalyRating='" + bbAnomalyRating + '\''
                + ", bbAnomalyReasonCode=" + Arrays.toString(bbAnomalyReasonCode) + ", bbAnomalyScore=" + bbAnomalyScore
                + ", bbAssessment=" + bbAssessment + ", bbAssessmentRating='" + bbAssessmentRating + '\''
                + ", bbAuthConfidenceScore=" + bbAuthConfidenceScore + ", bbAuthHistoricalScoreMean="
                + bbAuthHistoricalScoreMean + ", bbAuthHistoricalScoreStd=" + bbAuthHistoricalScoreStd
                + ", bbAuthScore=" + bbAuthScore + ", bbBotRating='" + bbBotRating + '\'' + ", bbBotScore=" + bbBotScore
                + ", bbFraudRating='" + bbFraudRating + '\'' + ", bbFraudScore=" + bbFraudScore
                + ", behaviosecBotReasons=" + Arrays.toString(behaviosecBotReasons) + ", behaviosecConfidence="
                + behaviosecConfidence + ", behaviosecDataIntegrityReasons="
                + Arrays.toString(behaviosecDataIntegrityReasons) + ", behaviosecPopulationProfileChallengerRiskRank="
                + behaviosecPopulationProfileChallengerRiskRank + ", behaviosecPopulationProfileChallengerScore="
                ...
                + behaviosecUserid + '\'' + ", browser='" + browser + '\'' + ", browserVersion='" + browserVersion
                + '\'' + ", browserAddon='" + browserAddon + '\'' + ", browserAddonHash='" + browserAddonHash + '\''
                + ", browserAnomaly='" + browserAnomaly + '\'' + ", browserLanguage='" + browserLanguage + '\''
                + ", browserSpoofRating='" + browserSpoofRating + '\'' + ", browserStringHash='" + browserStringHash
                + '\'' + ", browserString='" + browserString + '\'' + ", pluginNumber=" + pluginNumber
                + ", profiledUrl='" + profiledUrl + '\'' + ", canvasHash='" + canvasHash + '\'' + ", cidrNumber="
                + cidrNumber + ", deviceActivities='" + deviceActivities + '\'' + ", deviceAttributes="
                + Arrays.toString(deviceAttributes) + ", deviceFingerprint='" + deviceFingerprint + '\''
                + ", deviceFingerprintActivities='" + deviceFingerprintActivities + '\''
                + ", deviceFingerprintAttributes=" + Arrays.toString(deviceFingerprintAttributes)
                + ", deviceFingerprintFirstSeen='" + deviceFingerprintFirstSeen + '\'' + ", deviceFingerprintResult='"
                + deviceFingerprintResult + '\'' + ", deviceFingerprintScore=" + deviceFingerprintScore
                + ", deviceFingerprintWorstScore=" + deviceFingerprintWorstScore + ", deviceFirstSeen='"
                + deviceFirstSeen + '\'' + ", deviceHealthReasons=" + Arrays.toString(deviceHealthReasons)
                + ", deviceId='" + deviceId + '\'' + ", deviceIdConfidence=" + deviceIdConfidence + ", deviceMemory="
                + deviceMemory + ", deviceModel='" + deviceModel + '\'' + ", deviceName='" + deviceName + '\''
                + ", agentLanguage='" + agentLanguage + '\'' + ", deviceResult='" + deviceResult + '\''
                + ", deviceScore=" + deviceScore + ", deviceWorstScore=" + deviceWorstScore + ", digitalId='"
                + digitalId + '\'' + ", digitalIdActivities='" + digitalIdActivities + '\'' + ", digitalIdAttributes="
                + Arrays.toString(digitalIdAttributes) + ", digitalIdConfidence=" + digitalIdConfidence
                + ", digitalIdConfidenceRating='" + digitalIdConfidenceRating + '\'' + ", digitalIdFirstSeen='"
                + digitalIdFirstSeen + '\'' + ", digitalIdReasonCode='" + digitalIdReasonCode + '\''
                + ", digitalIdResult='" + digitalIdResult + '\'' + ", digitalIdTrustScore=" + digitalIdTrustScore
                + ", digitalIdTrustScoreRating='" + digitalIdTrustScoreRating + '\''
                + ", digitalIdTrustScoreReasonCode=" + Arrays.toString(digitalIdTrustScoreReasonCode)
                + ", digitalIdTrustScoreSummaryReasonCode=" + Arrays.toString(digitalIdTrustScoreSummaryReasonCode)
                + ", dnsIp='" + dnsIp + '\'' + ", dnsIpAttributes=" + Arrays.toString(dnsIpAttributes) + ", dnsIpCity='"
                + dnsIpCity + '\'' + ", dnsIpGeo='" + dnsIpGeo + '\'' + ", dnsIpIsp='" + dnsIpIsp + '\''
                + ", dnsIpOrganization='" + dnsIpOrganization + '\'' + ", dnsIpPostalCode='" + dnsIpPostalCode + '\''
                + ", dnsIpRegion='" + dnsIpRegion + '\'' + ", emailageEmailriskscoreEaadvice='"
                + emailageEmailriskscoreEaadvice + '\'' + ", emailageEmailriskscoreEareason='"
                + emailageEmailriskscoreEareason + '\'' + ", emailageEmailriskscoreEascore="
                + emailageEmailriskscoreEascore + ", emailageEmailriskscoreEariskbandid="
                + emailageEmailriskscoreEariskbandid + ", emailageEmailriskscoreEmailCreationDays="
                + emailageEmailriskscoreEmailCreationDays + ", emailageEmailriskscoreEmailage='"
                + emailageEmailriskscoreEmailage + '\'' + ", emailageEmailriskscorePhonecarriertype='"
                + emailageEmailriskscorePhonecarriertype + '\'' + ", emailageEmailriskscorePhoneownermatch='"
                + emailageEmailriskscorePhoneownermatch + '\'' + ", emailageEmailriskscorePhonetofullnameconfidence="
                + emailageEmailriskscorePhonetofullnameconfidence + ", emailageEmailriskscorePhonetolastnameconfidence="
                + emailageEmailriskscorePhonetolastnameconfidence + ", emailageEmailriskscoreIpRisklevel='"
                + emailageEmailriskscoreIpRisklevel + '\'' + ", emailageEmailriskscoreIpRiskreason='"
                + emailageEmailriskscoreIpRiskreason + '\'' + ", emailageEmailriskscore='" + emailageEmailriskscore
                + '\'' + ", emailageEmailriskscoreDomainrisklevel='" + emailageEmailriskscoreDomainrisklevel + '\''
                + ", emailageEmailriskscoreDomainCreationDays=" + emailageEmailriskscoreDomainCreationDays
                + ", emailageEmailriskscoreDomainage='" + emailageEmailriskscoreDomainage + '\''
                + ", emailageEmailriskscoreDomainexists='" + emailageEmailriskscoreDomainexists + '\''
                + ", emailageEmailriskscoreDomaincountry='" + emailageEmailriskscoreDomaincountry + '\''
                + ", emailageEmailriskscoreDomaincompany='" + emailageEmailriskscoreDomaincompany + '\''
                + ", emailageEmailriskscoreDomainname='" + emailageEmailriskscoreDomainname + '\''
                + ", emailageEmailriskscoreDomaincategory='" + emailageEmailriskscoreDomaincategory + '\''
                + ", emailageEmailriskscoreOveralldigitalidentityscore="
                + emailageEmailriskscoreOveralldigitalidentityscore + ", emailageEmailriskscoreDisdescription='"
                + emailageEmailriskscoreDisdescription + '\'' + ", eventDatetime='" + eventDatetime + '\''
                + ", eventId=" + eventId + ", finalReviewStatus='" + finalReviewStatus + '\''
                + ", fuzzyDeviceAttributes=" + Arrays.toString(fuzzyDeviceAttributes) + ", fuzzyDeviceFirstSeen='"
                + fuzzyDeviceFirstSeen + '\'' + ", fuzzyDeviceId='" + fuzzyDeviceId + '\''
                + ", fuzzyDeviceIdConfidence=" + fuzzyDeviceIdConfidence + ", fuzzyDeviceMatchResult='"
                + fuzzyDeviceMatchResult + '\'' + ", fuzzyDeviceResult='" + fuzzyDeviceResult + '\''
                + ", fuzzyDeviceScore=" + fuzzyDeviceScore + ", fuzzyDeviceWorstScore=" + fuzzyDeviceWorstScore
                + ", geofenceCountryGps='" + geofenceCountryGps + '\'' + ", geofenceRegionGps='" + geofenceRegionGps
                + '\'' + ", gpsSpoof='" + gpsSpoof + '\'' + ", gpuName='" + gpuName + '\'' + ", gpuVendor='" + gpuVendor
                + '\'' + ", hwFingerprint='" + hwFingerprint + '\'' + ", jbRoot=" + jbRoot + ", jsBrowser='" + jsBrowser
                + '\'' + ", jsBrowserStringHash='" + jsBrowserStringHash + '\'' + ", jsFontsHash='" + jsFontsHash + '\''
                + ", jsFontsNumber=" + jsFontsNumber + ", jsOs='" + jsOs + '\'' + ", liveness='" + liveness + '\''
                + ", macAddress='" + macAddress + '\'' + ", mathRoutine='" + mathRoutine + '\'' + ", mimeTypeHash='"
                + mimeTypeHash + '\'' + ", multiDisplay='" + multiDisplay + '\'' + ", nationalId='" + nationalId + '\''
                + ", passwordHash='" + passwordHash + '\'' + ", passwordHashActivities='" + passwordHashActivities
                + '\'' + ", passwordHashAttributes=" + Arrays.toString(passwordHashAttributes)
                + ", passwordHashFirstSeen='" + passwordHashFirstSeen + '\'' + ", passwordHashResult='"
                + passwordHashResult + '\'' + ", passwordHashScore=" + passwordHashScore + ", passwordHashWorstScore="
                + passwordHashWorstScore + ", policy='" + policy + '\'' + ", privateBrowsing='" + privateBrowsing + '\''
                + ", proxyIp='" + proxyIp + '\'' + ", proxyIpActivities='" + proxyIpActivities + '\''
                + ", proxyIpAttributes=" + Arrays.toString(proxyIpAttributes) + ", proxyIpCity='" + proxyIpCity + '\''
                + ", proxyIpConnectionType='" + proxyIpConnectionType + '\'' + ", proxyIpFirstSeen='" + proxyIpFirstSeen
                + '\'' + ", proxyIpGeo='" + proxyIpGeo + '\'' + ", proxyIpHome='" + proxyIpHome + '\''
                + ", proxyIpIsp='" + proxyIpIsp + '\'' + ", proxyIpLatitude=" + proxyIpLatitude + ", proxyIpLongitude="
                + proxyIpLongitude + ", proxyIpOrganization='" + proxyIpOrganization + '\''
                + ", proxyIpOrganizationType='" + proxyIpOrganizationType + '\'' + ", proxyIpPostalCode='"
                + proxyIpPostalCode + '\'' + ", proxyIpRegion='" + proxyIpRegion + '\'' + ", proxyIpResult='"
                + proxyIpResult + '\'' + ", proxyIpRoutingType='" + proxyIpRoutingType + '\'' + ", proxyIpScore="
                + proxyIpScore + ", proxyIpWorstScore=" + proxyIpWorstScore + ", proxyIpv6='" + proxyIpv6 + '\''
                + ", proxyName='" + proxyName + '\'' + ", proxyScore=" + proxyScore + ", proxyType='" + proxyType + '\''
                + ", relatedRequestId='" + relatedRequestId + '\'' + ", remoteAccess='" + remoteAccess + '\''
                + ", remoteAccessRating='" + remoteAccessRating + '\'' + ", remoteAccessScore=" + remoteAccessScore
                + ", remoteDesktop='" + remoteDesktop + '\'' + ", screenRes='" + screenRes + '\''
                + ", screenResAnomaly='" + screenResAnomaly + '\'' + ", screenResZoom=" + screenResZoom + ", seRating='"
                + seRating + '\'' + ", seScore=" + seScore + ", smartLearningFraudRating='" + smartLearningFraudRating
                + '\'' + ", smartLearningPScore=" + smartLearningPScore + ", smartLearningPolicyScore="
                + smartLearningPolicyScore + ", smartLearningReasonCode='" + smartLearningReasonCode + '\''
                + ", smartLearningRiskRank=" + smartLearningRiskRank + ", smartLearningSummaryReasonCode='"
                + smartLearningSummaryReasonCode + '\'' + ", timeZone=" + timeZone + ", timeZoneDstOffset="
                + timeZoneDstOffset + ", timezoneName='" + timezoneName + '\'' + ", timezoneOffsetAnomaly='"
                + timezoneOffsetAnomaly + '\'' + ", tmxPolicyScore=" + tmxPolicyScore + ", tmxRiskRating='"
                + tmxRiskRating + '\'' + ", tmxVariables='" + tmxVariables + '\'' + ", trueIp='" + trueIp + '\''
                + ", trueIpActivities='" + trueIpActivities + '\'' + ", trueIpAttributes="
                + Arrays.toString(trueIpAttributes) + ", trueIpCity='" + trueIpCity + '\''
                + ", trueIpCountryConfidence=" + trueIpCountryConfidence + ", trueIpFirstSeen='" + trueIpFirstSeen
                + '\'' + ", trueIpGeo='" + trueIpGeo + '\'' + ", trueIpIsp='" + trueIpIsp + '\'' + ", trueIpLastEvent='"
                + trueIpLastEvent + '\'' + ", trueIpOrganization='" + trueIpOrganization + '\''
                + ", trueIpOrganizationType='" + trueIpOrganizationType + '\'' + ", trueIpPostalCode='"
                + trueIpPostalCode + '\'' + ", trueIpRegion='" + trueIpRegion + '\'' + ", trueIpResult='" + trueIpResult
                + '\'' + ", trueIpConnectionType='" + trueIpConnectionType + '\'' + ", trueIpRoutingType='"
                + trueIpRoutingType + '\'' + ", trueIpScore=" + trueIpScore + ", trueIpWorstScore=" + trueIpWorstScore
                + ", trueIpv6='" + trueIpv6 + '\'' + ", uaAgent='" + uaAgent + '\'' + ", uaMobile='" + uaMobile + '\''
                + ", unknownSession='" + unknownSession + '\'' + ", virtualDevice=" + virtualDevice
                + ", virtualDeviceReason='" + virtualDeviceReason + '\'' + ", vpnReason='" + vpnReason + '\''
                + ", vpnScore=" + vpnScore + ", webglHash='" + webglHash + '\'' + ", webrtcExternalIp='"
                + webrtcExternalIp + '\'' + ", customerEventType='" + customerEventType + '\'' + ", inputIpAddress='"
                + inputIpAddress + '\'' + ", inputIpIsp='" + inputIpIsp + '\'' + ", inputIpCity='" + inputIpCity + '\''
                + ", inputIpRegion='" + inputIpRegion + '\'' + ", inputIpGeo='" + inputIpGeo + '\''
                + ", inputIpRoutingType='" + inputIpRoutingType + '\'' + ", webSessionId='" + webSessionId + '\''
                + ", conditionAttrib5='" + conditionAttrib5 + '\'' + ", agentBrand='" + agentBrand + '\''
                + ", agentModel='" + agentModel + '\'' + ", applicationName='" + applicationName + '\''
                + ", transactionId='" + transactionId + '\'' + ", lineOfBusiness='" + lineOfBusiness + '\''
                + ", accountAddressStreet2='" + accountAddressStreet2 + '\'' + ", conditionAttrib1='" + conditionAttrib1
                + '\'' + ", conditionAttrib2='" + conditionAttrib2 + '\'' + ", customCount1=" + customCount1
                + ", localAttrib1='" + localAttrib1 + '\'' + ", customCount4='" + customCount4 + '\''
                + ", conditionAttrib6='" + conditionAttrib6 + '\'' + ", conditionAttrib3='" + conditionAttrib3 + '\''
                + ", primaryAccountBalanceUsd=" + primaryAccountBalanceUsd + ", primaryAccountBalance="
                + primaryAccountBalance + ", primaryAccountBalanceCurrency='" + primaryAccountBalanceCurrency + '\''
                + ", conditionAttrib10='" + conditionAttrib10 + '\'' + ", conditionAttrib9=" + conditionAttrib9
                + ", conditionAttrib4='" + conditionAttrib4 + '\'' + ", conditionAttrib7='" + conditionAttrib7 + '\''
                + ", conditionAttrib8='" + conditionAttrib8 + '\'' + ", localAttrib12='" + localAttrib12 + '\''
                + ", localAttrib13='" + localAttrib13 + '\'' + ", localAttrib14='" + localAttrib14 + '\''
                + ", localAttrib15='" + localAttrib15 + '\'' + ", customCount2='" + customCount2 + '\''
                + ", customCount13='" + customCount13 + '\'' + ", summaryReasonCode='" + summaryReasonCode + '\''
                + ", os='" + os + '\'' + ", osVersion='" + osVersion + '\'' + ", tmxSummaryReasonCode='"
                + tmxSummaryReasonCode + '\'' + ", lastUpdated='" + lastUpdated + '\'' + ", summaryReasonCodeOriginal='"
                + summaryReasonCodeOriginal + '\'' + '}';
    }

    public String toStringRawResponse() {
        return "{" + "ucid='" + ucid + '\"' + ", id=" + id + ", brand='" + brand + '\"' + ", sessionId='" + sessionId
                + '\"' + ", userId=" + userId + ", email='" + email + '\"' + ", mobileCode=" + mobileCode + ", mobile='"
                + mobile + '\"' + ", eventType='" + eventType + '\"' + ", isFromApp=" + isFromApp + ", createTime='"
                + createTime + '\"' + ", policyScore=" + policyScore + ", riskRating='" + riskRating + '\"'
                + ", reviewStatus='" + reviewStatus + '\"' + ", requestResult='" + requestResult + '\"'
                + ", accountAddress='" + accountAddress + '\"' + ", accountAddressActivities='"
                + accountAddressActivities + '\"' + ", accountAddressAttributes="
                + Arrays.toString(accountAddressAttributes) + ", accountAddressCity='" + accountAddressCity + '\"'
                + ", accountAddressCountry='" + accountAddressCountry + '\"' + ", accountAddressFirstSeen='"
                + accountAddressFirstSeen + '\"' + ", accountAddressResult='" + accountAddressResult + '\"'
    ...
    public String getSummaryReasonCodeOriginal() {
        return summaryReasonCodeOriginal;
    }

    public void setSummaryReasonCodeOriginal(String summaryReasonCodeOriginal) {
        this.summaryReasonCodeOriginal = summaryReasonCodeOriginal;
    }
}
