...
public class LnSessionParsedObjectFactory {
    ...
    static String summaryReasonCodeString =
            "{\"policy_detail_api\":[{\"customer\":{\"pvid\":\"1000180580\",\"review_status\":\"pass\",\"risk_rating\":\"low\",\"rules\":[{\"reason_code\":\"testRule\",\"rid\":\"1156819363\",\"score\":\"-10\"}]},\"id\":\"0\",\"type\":\"champion\"}]}";
    ...
    public static LnSessionParsedObject generateLexisNexisDataForUserId(String uid, Integer userId, Integer eventId) {
        return new LnSessionParsedObject(
                ...
                "1",
                1,
                summaryReasonCodeString,
                "Windows",
                Arrays.toString(new String[] {"\"Identity_Negative_History\"", "\"Identity_Spoofing\""}));
    }
