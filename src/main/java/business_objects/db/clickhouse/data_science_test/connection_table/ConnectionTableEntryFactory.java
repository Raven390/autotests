...
public class ConnectionTableEntryFactory {
    ...
    public static ConnectionTableEntry getConnectionTableEntry(
            ClientHelper userFrom, ClientHelper userTo, ConnectionAttributes connectionAttrName) {
    ...
    public static ConnectionTableEntry getConnectionTableEntry(
            ClientHelper userFrom, ClientHelper userTo, String ipAddress) {
        return new ConnectionTableEntry(
                userFrom.getUcid(),
                userTo.getUcid(),
                CONNECTION_TYPE_SAME_PERSON,
                1d,
                List.of(new ConnectionTableEntry.ConnectionInfo(
                        CONNECTION_ATTRIBUTE_NAME_IP, ipAddress, ipAddress, CONNECTION_TYPE_RELATION_TYPE_EXACT)),
                getCurrentTimestampDbFormat(),
                STATUS_NEW,
                0);
    }
    ...
    public static ConnectionTableEntry getConnectionTableEntryForFiltration(
        ...
        return new ConnectionTableEntry(
                ...
                List.of(new ConnectionTableEntry.ConnectionInfo(
                        ...
                        CONNECTION_SEARCH_DATA_EMAIL1,
                        CONNECTION_SEARCH_DATA_EMAIL2,
        ...
        return new ConnectionTableEntry(
                ...
                List.of(
                        ...
                        new ConnectionTableEntry.ConnectionInfo(
                                ...
                                CONNECTION_SEARCH_DATA_DOCUMENT,
                                CONNECTION_SEARCH_DATA_DOCUMENT,
                                CONNECTION_TYPE_RELATION_TYPE_EXACT),
                        new ConnectionTableEntry.ConnectionInfo(
                                CONNECTION_ATTRIBUTE_NAME_NAME_AND_BIRTH,
    ...
    public static ConnectionTableEntry getConnectionTableEntryForUiFiltration1(
            ClientHelper userFrom, ClientHelper userTo) {
        return new ConnectionTableEntry(
                userFrom.getUcid(),
                userTo.getUcid(),
    ...
    public static ConnectionTableEntry getConnectionTableEntryForUiFiltration2(
            ClientHelper userFrom, ClientHelper userTo) {
        return new ConnectionTableEntry(
                userFrom.getUcid(),
                userTo.getUcid(),
    ...
    public static ConnectionTableEntry getConnectionTableEntryForUiFiltration3(
            ClientHelper userFrom, ClientHelper userTo) {
        return new ConnectionTableEntry(
                userFrom.getUcid(),
                userTo.getUcid(),
    ...
    public static ConnectionTableEntry getConnectionTableEntryForUiFiltration4(
            ClientHelper userFrom, ClientHelper userTo) {
        return new ConnectionTableEntry(
                userFrom.getUcid(),
                userTo.getUcid(),
                ...
                List.of(new ConnectionTableEntry.ConnectionInfo(
                        CONNECTION_ATTRIBUTE_NAME_DEVICE,
                        CONNECTION_SEARCH_DATA_DEVICE2,
                        CONNECTION_SEARCH_DATA_DEVICE2,
                        CONNECTION_TYPE_RELATION_TYPE_EXACT)),
                getCurrentTimestampDbFormat(),
                STATUS_NEW,
    ...
    public static ConnectionTableEntry getConnectionTableEntryForUiFiltration5(
            ClientHelper userFrom, ClientHelper userTo) {
        return new ConnectionTableEntry(
                userFrom.getUcid(),
                userTo.getUcid(),
    ...
    public static ConnectionTableEntry getConnectionTableEntryForUiFiltration6(
            ClientHelper userFrom, ClientHelper userTo) {
        return new ConnectionTableEntry(
                userFrom.getUcid(),
                userTo.getUcid(),
    ...
    public static ConnectionTableEntry getConnectionTableEntry(
            ClientHelper userFrom, ClientHelper userTo, Double connectionScore) {
        return new ConnectionTableEntry(
                userFrom.getUcid(),
                userTo.getUcid(),
                CONNECTION_TYPE_SAME_PERSON,
    ...
    public static ConnectionTableEntry getConnection(
            ClientHelper fromClient, ClientHelper toClient, Double connectionScore) {
        return new ConnectionTableEntry(
                fromClient.getUcid(),
                toClient.getUcid(),
                CONNECTION_TYPE_SAME_IDENTITY,
