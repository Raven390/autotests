...
public class CrmTbKycFilesFactory {
    ...
    public static CrmTbKycFilesObject generateKycFilesObjectByClient(ClientHelper client) {
        return CrmTbKycFilesObject.builder()
                .sourceIdSt(1)
                .brandUid(1)
                ...
                .uploadTimeUtc(getCurrentTimestampDbFormat())
                .updateTime(getCurrentTimestampDbFormat())
                .updateTimeUtc(getCurrentTimestampDbFormat())
                .isDel(0)
