...
public class CrmTbAccountObject {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(sourceIdSt, that.sourceIdSt)
                ...
                && Objects.equals(createDateUtc, that.createDateUtc)
                ...
                && Objects.equals(lastOrderUtc, that.lastOrderUtc)
                ...
                && Objects.equals(rebateAccountNr, that.rebateAccountNr)
                && Objects.equals(ibId, that.ibId)
                && Objects.equals(pId, that.pId)
                && Objects.equals(isSwapFree, that.isSwapFree)
                && Objects.equals(isPamm, that.isPamm)
                && Objects.equals(isCent, that.isCent)
    ...
    public String toString() {
        return "CrmTbAccountObject{" + "sourceIdSt=" + sourceIdSt + ", brandUid=" + brandUid + ", brand='" + brand
                + '\'' + ", regulator='" + regulator + '\'' + ", userId=" + userId + ", ucid='" + ucid + '\''
                + ", account=" + account + ", serverIdSt=" + serverIdSt + ", serverName='" + serverName + '\''
                + ", accountTypeId=" + accountTypeId + ", accountType='" + accountType + '\'' + ", accountGroup='"
                + accountGroup + '\'' + ", platform='" + platform + '\'' + ", createTime='" + createTime + '\''
                + ", createTimeUtc='" + createTimeUtc + '\'' + ", createDate='" + createDate + '\''
                + ", createDateUtc='" + createDateUtc + '\'' + ", accountStatus='" + accountStatus + '\''
                + ", lastLogin='" + lastLogin + '\'' + ", lastLoginUtc='" + lastLoginUtc + '\'' + ", lastOrder='"
                + lastOrder + '\'' + ", lastOrderUtc='" + lastOrderUtc + '\'' + ", balance=" + balance + ", currency='"
                + currency + '\'' + ", balanceUsd=" + balanceUsd + ", equity=" + equity + ", credit=" + credit
                + ", pnl=" + pnl + ", leverage=" + leverage + ", marginFree=" + marginFree + ", isRebateAccount='"
                + isRebateAccount + '\'' + ", rebateAccountNr='" + rebateAccountNr + '\'' + ", ibId=" + ibId + ", pId="
                + pId + ", isSwapFree=" + isSwapFree + ", isPamm=" + isPamm + ", isCent=" + isCent + ", isArchive="
                + isArchive + ", isHidden=" + isHidden + ", isDel=" + isDel + ", isDelete=" + isDeleted
