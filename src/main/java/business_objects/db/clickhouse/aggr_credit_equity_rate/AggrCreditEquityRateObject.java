...
public class AggrCreditEquityRateObject {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(serverId, that.serverId)
                ...
                && Objects.equals(currentEquityDate, that.currentEquityDate)
                && Objects.equals(currentEquity, that.currentEquity)
                && Objects.equals(sumCreditOrderDate, that.sumCreditOrderDate)
                && Objects.equals(sumCreditOrder, that.sumCreditOrder)
                && Objects.equals(creditEquityRatioDate, that.creditEquityRatioDate)
                && Objects.equals(creditEquityRatio, that.creditEquityRatio);
    }
    ...
    public String toString() {
        return "aggrsumCreditOrderByTradesObject{" + "serverId='" + serverId + '\'' + ", tradingAccount="
                + tradingAccount + ", currentEquityDate='" + currentEquityDate + '\'' + ", currentEquity='"
                + currentEquity + '\'' + ", sumCreditOrderDate='" + sumCreditOrderDate + '\'' + ", sumCreditOrder='"
                + sumCreditOrder + '\'' + ", creditEquityRatioDate='" + creditEquityRatioDate + '\''
