...
public class Mt5DealsCoercedToxicityObject {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(brand, that.brand)
                ...
                && Objects.equals(toxicityUsd, that.toxicityUsd)
    ...
    public String toString() {
        return "Mt5DealsCoercedToxicityObject{" + "brand='" + brand + '\'' + ", regulator='" + regulator + '\''
                + ", userId=" + userId + ", ucid='" + ucid + '\'' + ", account=" + account + ", platform='" + platform
                + '\'' + ", serverId=" + serverId + ", serverName='" + serverName + '\'' + ", accountType='"
                + accountType + '\'' + ", accountGroup='" + accountGroup + '\'' + ", accountCurrency='"
                + accountCurrency + '\'' + ", deal=" + deal + ", order=" + order + ", action=" + action + ", entry="
                + entry + ", reason=" + reason + ", contractSize=" + contractSize + ", time='" + time + '\''
                + ", timeUtc='" + timeUtc + '\'' + ", symbol='" + symbol + '\'' + ", symbolUnderlying='"
                + symbolUnderlying + '\'' + ", baseCurrency='" + baseCurrency + '\'' + ", quoteCurrency='"
                + quoteCurrency + '\'' + ", rateUsdBase=" + rateUsdBase + ", rateUsdQuote=" + rateUsdQuote
                + ", rateUsdAcc=" + rateUsdAcc + ", price=" + price + ", volume=" + volume + ", volumeLots="
                + volumeLots + ", notionalValueUsd=" + notionalValueUsd + ", profit=" + profit + ", storage=" + storage
                + ", commission=" + commission + ", profitUsd=" + profitUsd + ", storageUsd=" + storageUsd
                + ", commissionUsd=" + commissionUsd + ", expertId=" + expertId + ", positionId=" + positionId
                + ", comment='" + comment + '\'' + ", sl=" + sl + ", tp=" + tp + ", priceGateway=" + priceGateway
                + ", marketBid=" + marketBid + ", marketAsk=" + marketAsk + ", rateProfit=" + rateProfit
                + ", toxicityUsd=" + toxicityUsd + ", isDeleted=" + isDeleted + ", lastUpdated='" + lastUpdated + '\''
