...
public class AggrCreditRiskFreeRevenueRatioObject {
    ...
    public AggrCreditRiskFreeRevenueRatioObject(
            ...
            String currentRiskFreeRevenueDate,
            Double currentRiskFreeRevenue,
            String sumCreditOrderDate,
            Double sumCreditOrder,
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(serverId, that.serverId)
                ...
                && Objects.equals(currentRiskFreeRevenue, that.currentRiskFreeRevenue)
                && Objects.equals(sumCreditOrderDate, that.sumCreditOrderDate)
                && Objects.equals(sumCreditOrder, that.sumCreditOrder)
                && Objects.equals(creditRiskFreeRevenueRatioDate, that.creditRiskFreeRevenueRatioDate)
                && Objects.equals(creditRiskFreeRevenueRatio, that.creditRiskFreeRevenueRatio);
    }
    ...
    public int hashCode() {
        return Objects.hash(
                serverId,
                tradingAccount,
                currentRiskFreeRevenueDate,
                currentRiskFreeRevenue,
                sumCreditOrderDate,
                sumCreditOrder,
                creditRiskFreeRevenueRatioDate,
                creditRiskFreeRevenueRatio);
    }

    @Override
    public String toString() {
        return "aggrsumCreditOrderByTradesObject{" + "serverId='" + serverId + '\'' + ", tradingAccount="
                + tradingAccount + ", currentRiskFreeRevenueDate='" + currentRiskFreeRevenueDate + '\''
                + ", currentRiskFreeRevenue='" + currentRiskFreeRevenue + '\'' + ", sumCreditOrderDate='"
                + sumCreditOrderDate + '\'' + ", sumCreditOrder='" + sumCreditOrder + '\''
                + ", creditRiskFreeRevenueRatioDate='" + creditRiskFreeRevenueRatioDate + '\''
                + ", creditRiskFreeRevenueRatioDate='" + creditRiskFreeRevenueRatio + '\'' + '}';
    }
}
