...
public class PaymentEventsObject {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(paymentId, that.paymentId)
                ...
                && Objects.equals(finalDecisionId, that.finalDecisionId)
    ...
    public int hashCode() {
        return Objects.hash(
                paymentId, crmId, type, finalDecisionId, ucid, dateCreated, dateUpdated, dateDecided, deliveryStatus);
    }

    @Override
    public String toString() {
        return "PaymentEventsObject{" + "paymentId=" + paymentId + ", crmId='" + crmId + '\'' + ", type='" + type + '\''
                + ", finalDecisionId=" + finalDecisionId + ", ucid='" + ucid + '\'' + ", dateCreated=" + dateCreated
                + ", dateUpdated=" + dateUpdated + ", dateDecided=" + dateDecided + ", deliveryStatus='"
                + deliveryStatus + '\'' + '}';
    }
}
