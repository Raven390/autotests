...
public class WithdrawalDbEventCpsData {
    ...
    public String toString() {
        return "WithdrawalDbEventCpsData{" + "createTime='" + createTime + '\'' + ", id=" + id + ", userId=" + userId
                + ", mt4Account=" + mt4Account + ", brand='" + brand + '\'' + ", regulator='" + regulator + '\''
                + ", withdrawType=" + withdrawType + ", withdrawAmount=" + withdrawAmount + ", fee=" + fee
                + ", actualAmount=" + actualAmount + ", paymentAmount=" + paymentAmount + ", cardNumber='" + cardNumber
                + '\'' + ", isDel=" + isDel + ", updateTime='" + updateTime + '\'' + ", orderNumber='" + orderNumber
                + '\'' + ", deductCredit=" + deductCredit + ", userSalesId=" + userSalesId + ", accountSalesId="
                + accountSalesId + ", orderCurrency='" + orderCurrency + '\'' + ", checkingStatus=" + checkingStatus
                + ", rate=" + rate + ", toUsdRate=" + toUsdRate + '}';
    }
}
