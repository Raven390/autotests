...
public class EgRegistrationEvent {
    ...
    public boolean equals(Object o) {
        if (!(o instanceof EgRegistrationEvent that)) return false;
        return ibId == that.ibId && cpaId == that.cpaId && Objects.equals(schemaVersion, that.schemaVersion) && Objects.equals(
                id, that.id) && Objects.equals(createTime, that.createTime) && Objects.equals(clientId, that.clientId) && Objects.equals(
                        brand, that.brand) && Objects.equals(regulator, that.regulator) && Objects.equals(
                                metaTraderAccount, that.metaTraderAccount) && Objects.equals(type, that.type) && Objects.equals(
                                        eventDate, that.eventDate) && Objects.equals(metadata, that.metadata) && Objects.equals(
                                                initialEventTime, that.initialEventTime) && Objects.equals(referrerId, that.referrerId) && Objects.equals(
                                                        firstName, that.firstName) && Objects.equals(lastName, that.lastName) && Objects.equals(
                                                                email, that.email) && Objects.equals(phoneNumber, that.phoneNumber) && Objects.equals(
                                                                        birthday, that.birthday) && Objects.equals(firstLanguage, that.firstLanguage) && Objects.equals(
                                                                                nationalityCode, that.nationalityCode) && Objects.equals(residencyCode, that.residencyCode) && Objects.equals(
                                                                                        websiteUserType, that.websiteUserType) && Objects.equals(lexisNexis, that.lexisNexis);
    }
