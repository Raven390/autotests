...
public class OpenTradeFactory {
    ...
    private static TradeEventMt5.Payload generateMt5OpenTradeMtDbEventPayload(TradeEventMt5.RawApiData rawApiData) {
        return new TradeEventMt5.Payload(1.0, 1, 100d, "Automation tests", 1.0, 1.0, Utils.getRandomLongPositive(), 0L, 1, 2, 1, 100d, 0L, "", 1.0, 0, 100d, "1", 1, Utils.getRandomLongPositive(), 1d, 1d, 1d, 1d, 1, 1L, 1L, 1d, 1d, 1d, 1d, 1d, 1d, 1d, 1d, 1d, List.of(rawApiData), 0, 1d, "EURUSD", 1d, 1d, Utils.getCurrentTimestamp(), Utils.getCurrentTimestamp(), 1d, 1L, 0L, 0L, 0L);
    }
