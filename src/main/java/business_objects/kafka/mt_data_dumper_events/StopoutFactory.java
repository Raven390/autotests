...
public class StopoutFactory {
    ...
    static TradeEventMt4.Payload generateMt4StopoutTradeMtDbEventPayload() {
        return new TradeEventMt4.Payload(
                ...
                Utils.getCurrentTimestampMillis(),
                1,
                "Automation tests data dumper stopout event (so)",
                4d,
                5d,
                List.of(1d, 1d),
                List.of(1, 1),
    ...
    public static TradeEventMt5 generateStopoutTradeDataDumperMt5() {
        return new TradeEventMt5(
                generateMt5StopoutTradeMtDbEventHeader(),
                generateMt5StopoutTradeMtDbEventPayload(generateMt5StopoutTradeMtDbEventRawApiData()));
    }
