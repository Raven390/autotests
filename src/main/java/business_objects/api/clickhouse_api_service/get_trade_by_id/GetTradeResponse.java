...
public class GetTradeResponse {
    ...
    public String toString() {
        return "GetTradeResponse{" + "tradeId='" + tradeId + '\'' + ", tradeDate='" + tradeDate + '\''
                + ", tradingAccount='" + tradingAccount + '\'' + ", action='" + action + '\'' + ", entry='" + entry
                + '\'' + ", symbol='" + symbol + '\'' + ", profitUSD='" + profitUSD + '\'' + ", profit='" + profit
                + '\'' + ", volumeInLots='" + volumeInLots + '\'' + ", comment='" + comment + '\'' + ", reason='"
                + reason + '\'' + '}';
    }
