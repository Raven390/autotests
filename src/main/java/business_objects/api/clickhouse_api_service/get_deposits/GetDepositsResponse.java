...
public class GetDepositsResponse {
    ...
    public String toString() {
        return "GetDepositsResponse{" + "tradingAccount=" + tradingAccount + ", transferId=" + transferId
                + ", createTime='" + createTime + '\'' + ", clientId='" + clientId + '\'' + ", actualAmountUsd="
                + actualAmountUsd + ", actualAmount=" + actualAmount + ", paymentChannel='" + paymentChannel + '\''
