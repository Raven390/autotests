...
public class GetFastTradesResponse {
    ...
    public GetFastTradesResponse(
            String tradeDateOpen,
            String tradeDateClose,
            Long tradeId,
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(tradeDateOpen, that.tradeDateOpen)
                && Objects.equals(tradeDateClose, that.tradeDateClose)
    ...
    public int hashCode() {
        return Objects.hash(
                tradeDateOpen, tradeDateClose, tradeId, tradingAccount, serverId, symbol, profit, profitUsd, comment);
    }

    @Override
    public String toString() {
        return "GetFastTradesResponse{" + "tradeDateOpen='" + tradeDateOpen + '\'' + ", tradeDateClose='"
                + tradeDateClose + '\'' + ", tradeId=" + tradeId + ", tradingAccount=" + tradingAccount + ", serverId="
                + serverId + ", symbol='" + symbol + '\'' + ", profit=" + profit + ", profitUsd=" + profitUsd
                + ", comment='" + comment + '\'' + '}';
    }
}
