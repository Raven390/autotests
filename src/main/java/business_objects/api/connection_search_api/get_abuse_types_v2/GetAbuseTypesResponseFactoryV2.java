...
public class GetAbuseTypesResponseFactoryV2 {
    ...
    public static GetAbuseTypesResponseV2 getAbuseTypesResponseByFraud(ClientFraudTypes fraud, Double maxScoreToInitial,
            String abuseTypeStatus) {
        GetAbuseTypesResponseV2 response = new GetAbuseTypesResponseV2();
        response.abuseType = fraud.getFraudTypeCode();
        response.abuseTypeStatus = abuseTypeStatus;
        response.maxScoreToInitial = maxScoreToInitial;
