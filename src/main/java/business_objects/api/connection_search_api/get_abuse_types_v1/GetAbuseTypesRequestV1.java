...
public class GetAbuseTypesRequestV1 {
    ...
    public static Response getAbuseTypesByClientId(Map<String, Object> paramsMap) throws IOException {
        return new HttpHelper()
                .sendGetRequest(
                        CONNECTION_SEARCH_BASE_PATH_TEST + CONNECTION_SEARCH_GET_ABUSE_TYPES_BY_CLIENT_V1,
                        null,
                        paramsMap);
    }
    ...
    public static Response getAbuseTypesByAttributes(Map<String, Object> paramsMap) throws IOException {
        return new HttpHelper()
                .sendGetRequest(
                        CONNECTION_SEARCH_BASE_PATH_TEST + CONNECTION_SEARCH_GET_ABUSE_TYPES_BY_ATTRIBUTES,
                        null,
                        paramsMap);
    }
}
