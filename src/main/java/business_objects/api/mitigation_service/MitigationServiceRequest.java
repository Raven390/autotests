...
public class MitigationServiceRequest {
    ...
    public static Response getRestrictionCatalog() throws IOException {
        return new HttpHelper()
                .sendGetRequest(MITIGATION_SERVICE_BASE_PATH + MITIGATION_SERVICE_GET_RESTRICTION_CATALOG, null, null);
    }

    public static Response postRestriction(PostRestrictionRequestBody postRestrictionRequestBody) throws IOException {
        return new HttpHelper()
                .sendPostRequest(
                        MITIGATION_SERVICE_BASE_PATH + MITIGATION_SERVICE_RESTRICTIONS,
                        null,
                        null,
    ...
    public static PostRestrictionResponse postRestriction(ClientHelper client, String type, String code)
        ...
        return objectMapper.readValue(
                postRestriction(postRestrictionRequestBody).body().string(), PostRestrictionResponse.class);
    }
    ...
    public static Response getRestrictionsByUcid(String ucid) throws IOException {
        return new HttpHelper()
                .sendGetRequest(
                        MITIGATION_SERVICE_BASE_PATH + MITIGATION_SERVICE_RESTRICTIONS, null, Map.of("ucid", ucid));
    }

    public static Response getRestrictionsByUcidV3(String ucid) throws IOException {
        return new HttpHelper()
                .sendGetRequest(
                        MITIGATION_SERVICE_BASE_PATH + MITIGATION_SERVICE_RESTRICTIONS_V3, null, Map.of("ucid", ucid));
    }

    public static Response cancelRestriction(Integer restrictionId) throws IOException {
        return new HttpHelper()
                .sendPostRequest(
                        MITIGATION_SERVICE_BASE_PATH
                                + MITIGATION_SERVICE_CANCEL_RESTRICTION.replace(
                                        "{restrictionId}", restrictionId.toString()),
                        null,
                        null,
                        new CancelRestrictionRequestBody(
                                "Test", new CancelRestrictionRequestBody.UpdatedBy("API", "QA")));
    }
    ...
    public static Response getRestrictionCatalogInsight(String token) throws IOException {
        return new HttpHelper()
                .sendGetRequest(
                        MITIGATION_SERVICE_INSIGHT_BASE_PATH + MITIGATION_SERVICE_GET_RESTRICTION_CATALOG,
    ...
    public static Response postRestrictionInsight(String token, PostRestrictionRequestBody postRestrictionRequestBody)
        ...
        return new HttpHelper()
                .sendPostRequest(
                        MITIGATION_SERVICE_INSIGHT_BASE_PATH + MITIGATION_SERVICE_RESTRICTIONS,
                        Map.of("Authorization", String.format("Bearer %s", token)),
                        null,
                        postRestrictionRequestBody);
    }
    ...
    public static Response getRestrictionsByAccountServerIdInsight(String token, Integer account, Integer serverId)
        ...
        return new HttpHelper()
                .sendGetRequest(
                        MITIGATION_SERVICE_INSIGHT_BASE_PATH + MITIGATION_SERVICE_RESTRICTIONS,
                        Map.of("Authorization", String.format("Bearer %s", token)),
                        Map.of("accountId", account, "serverId", serverId));
    }

    public static Response cancelRestrictionInsight(
            String token, Integer id, CancelRestrictionRequestBody cancelRestrictionRequestBody) throws IOException {
        return new HttpHelper()
                .sendPostRequest(
                        String.format(MITIGATION_SERVICE_INSIGHT_BASE_PATH + MITIGATION_SERVICE_CANCEL_RESTRICTION, id),
                        Map.of("Authorization", String.format("Bearer %s", token)),
                        null,
    ...
    public static Response postRestrictionByBit(PostRestrictionByBitRequest restrictionBody) throws IOException {
        return new HttpHelper()
                .sendPostRequest(
                        MITIGATION_SERVICE_BASE_PATH + MITIGATION_SERVICE_RESTRICTIONS_BYBIT,
                        null,
                        null,
                        restrictionBody);
    }
    ...
    public static Response cancelRestrictionByIdByBit(CancelRestrictionByBitRequest cancelRestrictionRequestBody)
        ...
        return new HttpHelper()
                .sendPostRequest(
                        String.format(MITIGATION_SERVICE_BASE_PATH + MITIGATION_SERVICE_CANCEL_RESTRICTION_BYBIT),
                        null,
                        null,
                        cancelRestrictionRequestBody);
    }
