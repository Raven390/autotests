...
public class UserFactory {
    ...
    public static User autotestUserSeniorOPS() {
        return new User(ID_AUTOTEST_OPS24, EMAIL_AUTOTEST_OPS24_SENIOR, PASSWORD_BACKOFFICE_USERS, FIRST_NAME_AUTOTEST_ONE, LAST_NAME_AUTOTEST_ONE, EMAIL_AUTOTEST_OPS24_DUTY, ROLE_UNKNOWN);
    }
