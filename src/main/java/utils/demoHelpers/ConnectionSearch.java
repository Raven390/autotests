...
public class ConnectionSearch {
    ...
    public static void createDemoDataConnectionSearch(String userFromUcid) throws Exception {
        ...
        ConnectionTableEntry connectionTableEntry1 = new ConnectionTableEntry(userFromUcid, "infinox-424302", "Same Identity", 0.01, "[{\"connectionAttributeName\": \"email\", \"connectionAttributeValue\": \"kot.leopold@soyuzmultfilm.com\", \"sourceAttributeValue\": \"cat.leopold@soyuzmultfilm.com\", \"relationType\": \"similar\"}]", getCurrentTimestampDbFormat());
        ConnectionTableEntry connectionTableEntry2 = new ConnectionTableEntry(userFromUcid, "infinox-424303", "Same Identity", 0.17, "[{\"connectionAttributeName\": \"document\", \"connectionAttributeValue\": \"1271566157\", \"sourceAttributeValue\": \"1271566157\", \"relationType\": \"exact\"}]", getCurrentTimestampDbFormat());
        ConnectionTableEntry connectionTableEntry3 = new ConnectionTableEntry(userFromUcid, "infinox-424304", "Same Identity", 0.34, "[{\"connectionAttributeName\": \"device\", \"connectionAttributeValue\": \"lgAndr121276" + modificator + "\", \"sourceAttributeValue\": \"lgAndr121276" + modificator + "\", \"relationType\": \"exact\"}]", getCurrentTimestampDbFormat());

        ConnectionTableEntry connectionTableEntry4 = new ConnectionTableEntry("infinox-424302", "infinox-424305", "Same Identity", 0.5, "[{\"connectionAttributeName\": \"phone\", \"connectionAttributeValue\": \"+46700975436\", \"sourceAttributeValue\": \"+46700975435\", \"relationType\": \"similar\"}]", getCurrentTimestampDbFormat());
        ConnectionTableEntry connectionTableEntry5 = new ConnectionTableEntry("infinox-424302", "infinox-424306", "Same Identity", 0.66, "[{\"connectionAttributeName\": \"ip\", \"connectionAttributeValue\": \"124.12.12.42\", \"sourceAttributeValue\": \"124.12.12.46" + modificator + "\", \"relationType\": \"similar\"}]", getCurrentTimestampDbFormat());
        ConnectionTableEntry connectionTableEntry6 = new ConnectionTableEntry("infinox-424302", "infinox-424307", "Same Identity", 0.83, "[{\"connectionAttributeName\": \"session\", \"connectionAttributeValue\": \"1298u98ds98t" + modificator + "\", \"sourceAttributeValue\": \"1298u98ds98t" + modificator + "\", \"relationType\": \"exact\"}]", getCurrentTimestampDbFormat());
        ConnectionTableEntry connectionTableEntry7 = new ConnectionTableEntry("infinox-424304", "infinox-424308", "Same Identity", 0.82, "[{\"connectionAttributeName\": \"email\", \"connectionAttributeValue\": \"ETUU6t2aFDAdy7mnCBxhbr+UJiA7TDi2CRUvpqQ4/kw=\", \"sourceAttributeValue\": \"ETUU6t2aFDAdy7mnCBxhbr+UJiA7TDi2CRUvpqQ4/kw=\", \"relationType\": \"exact\"}]", getCurrentTimestampDbFormat());
        ConnectionTableEntry connectionTableEntry8 = new ConnectionTableEntry("infinox-424303", "infinox-424309", "Same Identity", 0.34, "[{\"connectionAttributeName\": \"phone\", \"connectionAttributeValue\": \"x3UCHwqCv3LDMrLP5XtrbA==\", \"sourceAttributeValue\": \"x3UCHwqCv3LDMrLP5XtrbA==\", \"relationType\": \"exact\"}]", getCurrentTimestampDbFormat());

        ConnectionTableEntry connectionTableEntry9 = new ConnectionTableEntry("infinox-424307", "infinox-424310", "Same Identity", 0.17, "[{\"connectionAttributeName\": \"email\", \"connectionAttributeValue\": \"4uxgXPyW5dBcjcXSPMcrsr/OWk7qylxy\", \"sourceAttributeValue\": \"4uxgXPyW5dBcjcXSPMcrsr/OWk7qylxy\", \"relationType\": \"exact\"}]", getCurrentTimestampDbFormat());
        ConnectionTableEntry connectionTableEntry10 = new ConnectionTableEntry("infinox-424308", "infinox-424311", "Same Identity", 0.17, "[{\"connectionAttributeName\": \"email\", \"connectionAttributeValue\": \"yjpB7jkXAMId8vRlXynlTk8cdqTtCvP0\", \"sourceAttributeValue\": \"7ZoSwJTKIG+OoGHfBgxdv7do7rC3aFRx\", \"relationType\": \"exact\"}]", getCurrentTimestampDbFormat());
