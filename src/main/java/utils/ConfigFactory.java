...
public class ConfigFactory {
    ...
    public static final String CLICKHOUSE_API_GET_CRYPTO_DEPOSITS = CONFIG.clickhouseGetCryptoDepositsPath();
    ...
    public static final String CLICKHOUSE_API_GET_FREE_MARGIN = CONFIG.clickhouseGetFreeMargin();
    ...
    public static final String PASSWORD_BACKOFFICE_USERS = CONFIG.passwordBackofficeUsers();
    ...
    public static final String ID_AUTOTEST_TRADING_OPS = CONFIG.idTradingOpsUser();
    ...
    public interface UserConfig extends Config {
        ...
        @Key("clickhouseGetCryptoDepositsPath")
        String clickhouseGetCryptoDepositsPath();
        ...
        @Key("clickhouseGetFreeMargin")
        String clickhouseGetFreeMargin();
        ...
        @Key("passwordBackofficeUsers")
        String passwordBackofficeUsers();
        ...
        @Key("idTradingOpsUser")
        String idTradingOpsUser();

        @Key("emailTradingOpsUser")
        String emailTradingOpsUser();

        @Key("firstNameTradingOpsUser")
        String firstNameTradingOpsUser();
    ...
    public static Boolean getHeadless() {
        if (isGitlab()) {
            writeLog("Set Headless mode to 'true'");
            return true;
        } else {
