...
public class Constants {
    ...
    public static final String STORY_RULE_ENGINE_WITHDRAWAL_NOTIFICATION_RULE = "Withdrawal notification rule ";
    ...
    public static final String CRM_TB_ACCOUNT_FOR_MT_TABLE_NAME = "vindex_test.crm___tb_account_for_mt";
    ...
    public static final String DICT_IS_TEST = "vindex_test.dict_is_test_account";
    public static final String DIGITAL_ID_TABLE_NAME = "data_science_test.digital_id";
    public static final String DOCUMENT_TABLE_NAME = "data_science_test.document";
    ...
    public static final String NAME_BIRTH_TABLE_NAME = "data_science_test.name_birth";
