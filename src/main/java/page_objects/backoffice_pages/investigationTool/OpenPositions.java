...
public class OpenPositions extends AbstractPage {
    ...
    private static final String OPEN_ROW_HEADER =
            "*[contains(@class, 'v-trading-tab-open-positions__sortable-cell') and text()= 'OPEN']";
    private static final String TPSL_ROW_HEADER = "*[contains(@class, 'v-header-cell') and text()= 'TP/SL']";
    private static final String FLOATING_PNL_ROW_HEADER =
            "*[contains(@class, 'v-trading-tab-open-positions__sortable-cell') and text()= 'FLOATING PNL']";
    ...
    public void checkAccountCellValue(String account, String expectedPlatform) {
        ...
        String locator = "//" + TABLE_CELL_LOCATOR + "//*[text()='" + account + "']/ancestor::" + TABLE_ROW_LOCATOR
                + "/" + TABLE_CELL_LOCATOR + "[1]" + "/descendant::" + SECONDARY_TEXT;
    ...
    public void checkTypeCellValue(String account, String symbol, String type) {
        ...
        super.waitForPageToLoad();
        String locator = "//" + TABLE_CELL_LOCATOR + "//*[text()='" + account + "']/ancestor::" + TABLE_ROW_LOCATOR
                + "/" + TABLE_CELL_LOCATOR + "[2]";
        page.locator(locator).waitFor(new Locator.WaitForOptions().setState(WaitForSelectorState.VISIBLE));
        assertEquals(
                symbol, page.locator(locator + "/descendant::" + PRIMARY_TEXT).textContent());
        assertEquals(
                type,
                page.locator(locator + "/descendant::" + DEAL_TYPE_TEXT_LOCATOR).textContent());
    }
    ...
    public void checkVolumeCellValue(String account, String volumeLots, String volumeUsd) {
        ...
        super.waitForPageToLoad();
        String locator = "//" + TABLE_CELL_LOCATOR + "//*[text()='" + account + "']/ancestor::" + TABLE_ROW_LOCATOR
                + "/" + TABLE_CELL_LOCATOR + "[3]";
        page.locator(locator).waitFor(new Locator.WaitForOptions().setState(WaitForSelectorState.VISIBLE));
        assertEquals(
                volumeLots + " lots",
                page.locator(locator + "/descendant::" + PRIMARY_TEXT).textContent());
        assertEquals(
                volumeUsd + " USD",
                page.locator(locator + "/descendant::" + SECONDARY_TEXT).textContent());
    }
    ...
    public void checkOpenCellValue(String account, String openPrice, String openTime) {
        ...
        super.waitForPageToLoad();
        String locator = "//" + TABLE_CELL_LOCATOR + "//*[text()='" + account + "']/ancestor::" + TABLE_ROW_LOCATOR
                + "/" + TABLE_CELL_LOCATOR + "[4]";
        page.locator(locator).waitFor(new Locator.WaitForOptions().setState(WaitForSelectorState.VISIBLE));
        assertEquals(
                openPrice,
                page.locator(locator + "/descendant::" + SECONDARY_TEXT).textContent());
        assertEquals(
                openTime, page.locator(locator + "/descendant::" + PRIMARY_TEXT).textContent());
    }
