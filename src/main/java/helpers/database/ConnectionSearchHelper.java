...
import static helpers.database.ClickhouseHelper.createSimpleClient;
...
public class ConnectionSearchHelper {
    ...
    public static void createDemoDataConnectionSearch(String userFromUcid) throws Exception {
        ...
        String modificator = getRandomInt().toString();

        ConnectionTableEntry connectionTableEntry1 = new ConnectionTableEntry(userFromUcid, "infinox-424302", "Same Identity", 0.01, "[{\"connectionAttributeName\": \"email\", \"connectionAttributeValue\": \"usersemail@test.test\", \"sourceAttributeValue\": \"similarmail" + modificator + "@test.test\", \"relationType\": \"similar\"}]");
        ConnectionTableEntry connectionTableEntry2 = new ConnectionTableEntry(userFromUcid, "infinox-424303", "Same Identity", 0.17, "[{\"connectionAttributeName\": \"document\", \"connectionAttributeValue\": \"" + modificator + "\", \"sourceAttributeValue\": \"" + modificator + "\", \"relationType\": \"exact\"}]");
        ...
        ConnectionTableEntry connectionTableEntry4 = new ConnectionTableEntry("infinox-424302", "infinox-424305", "Same Identity", 0.5, "[{\"connectionAttributeName\": \"phone\", \"connectionAttributeValue\": \"555-555-55" + modificator + "\", \"sourceAttributeValue\": \"555-555-56\", \"relationType\": \"similar\"}]");
        ...
        ConnectionTableEntry connectionTableEntry7 = new ConnectionTableEntry("infinox-424304", "infinox-424308", "Same Identity", 0.82, "[{\"connectionAttributeName\": \"email\", \"connectionAttributeValue\": \"semeemail" + modificator + "@test.test\", \"sourceAttributeValue\": \"semeemail" + modificator + "@test.test\", \"relationType\": \"exact\"}]");
        ConnectionTableEntry connectionTableEntry8 = new ConnectionTableEntry("infinox-424303", "infinox-424309", "Same Identity", 0.34, "[{\"connectionAttributeName\": \"phone\", \"connectionAttributeValue\": \"4441989" + modificator + "\", \"sourceAttributeValue\": \"4441989" + modificator + "\", \"relationType\": \"exact\"}]");

        ConnectionTableEntry connectionTableEntry9 = new ConnectionTableEntry("infinox-424307", "infinox-424310", "Same Identity", 0.17, "[{\"connectionAttributeName\": \"email\", \"connectionAttributeValue\": \"semeemail" + modificator + "@test.test\", \"sourceAttributeValue\": \"semeemail" + modificator + "@test.test\", \"relationType\": \"exact\"}]");
        ConnectionTableEntry connectionTableEntry10 = new ConnectionTableEntry("infinox-424308", "infinox-424311", "Same Identity", 0.17, "[{\"connectionAttributeName\": \"email\", \"connectionAttributeValue\": \"semeemail" + modificator + "@test.test\", \"sourceAttributeValue\": \"semeemail" + modificator + "@test.test\", \"relationType\": \"exact\"}]");
