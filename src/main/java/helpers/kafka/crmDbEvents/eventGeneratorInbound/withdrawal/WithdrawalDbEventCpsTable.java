...
public class WithdrawalDbEventCpsTable {
    ...
    public static WithdrawalDbEventCpsTable getWithdrawalDbEventCpsTable(WithdrawalDbEventDataCpsTable withdrawalEventData, WithdrawalDbEventMetadataCpsTable withdrawalEventMetadata) {
