...
public class MirrorTradingCloseTradeEventRuleDataFactory {
    ...
    public static DataHelper getMirrorTradingCloseTradeTest1Data() {
    ...
    public static DataHelper getMirrorTradingCloseTradeTest7Data() {
    ...
    public static DataHelper getMirrorTradingCloseTradeTest10Data() {
    ...
    public static DataHelper getMirrorTradingCloseTradeTest11Data() {
    ...
    public static DataHelper getMirrorTradingCloseTradeTest12Data() {
    ...
    public static DataHelper getMirrorTradingCloseTradeTest13Data() {
    ...
    public static DataHelper getMirrorTradingCloseTradeTest19Data() {
    ...
    public static DataHelper getMirrorTradingCloseTradeTest20Data() {
    ...
    public static DataHelper getMirrorTradingCloseTradeTest21Data() {
    ...
    public static DataHelper getMirrorTradingCloseTradeTest22Data() {
    ...
    public static DataHelper getMirrorTradingCloseTradeTest23Data() {
