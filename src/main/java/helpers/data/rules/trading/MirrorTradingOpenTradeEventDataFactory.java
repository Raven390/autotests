...
public class MirrorTradingOpenTradeEventDataFactory {
    ...
    private static DataHelper getMirrorTradingOpenTradeEventRuleTest1Data() {
    ...
    private static DataHelper getMirrorTradingOpenTradeEventRuleTest2Data() {
    ...
    private static DataHelper getMirrorTradingOpenTradeEventRuleTest3Data() {
    ...
    private static DataHelper getMirrorTradingOpenTradeEventRuleTest4Data() {
    ...
    private static DataHelper getMirrorTradingOpenTradeEventRuleTest5Data() {
    ...
    private static DataHelper getMirrorTradingOpenTradeEventRuleTest6Data() {
    ...
    @Step("")
    private static DataHelper getMirrorTradingOpenTradeEventRuleTest7Data() {
