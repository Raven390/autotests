...
public class MirrorTradingCloseTradeEventBybitRuleDataFactory {
    ...
    private static DataHelper getMirrorTradingCloseTradeBybitTest6Data() {
    ...
    private static DataHelper getMirrorTradingCloseTradeBybitTest7Data() {
    ...
    private static DataHelper getMirrorTradingCloseTradeBybitTest8Data() {
    ...
    private static DataHelper getMirrorTradingCloseTradeBybitTest9Data() {
    ...
    private static DataHelper getMirrorTradingCloseTradeBybitTest10Data() {
    ...
    private static DataHelper getMirrorTradingCloseTradeBybitTest11Data() {
    ...
    private static DataHelper getMirrorTradingCloseTradeBybitTest12Data() {
    ...
    private static DataHelper getMirrorTradingCloseTradeBybitTest13Data() {
    ...
    private static DataHelper getMirrorTradingCloseTradeBybitTest14Data() {
        DataHelper data = getMirrorTradingBybitRuleData(mirrorTradingCloseTradeBybitClient14);

        return data;
    }

    private static DataHelper getMirrorTradingCloseTradeBybitTest15Data() {
        DataHelper data = getMirrorTradingBybitRuleData(mirrorTradingCloseTradeBybitClient15);

        return data;
    }

    private static DataHelper getMirrorTradingCloseTradeBybitTest16Data() {
