...
public class EnoughTradesDataFactory {
    ...
    private static final ClientHelper enoughTradesRuleClient401 = getRandomVantageClientAllFields();
    private static final ClientHelper enoughTradesRuleClient402 = getRandomVantageClientAllFields();
    private static final ClientHelper enoughTradesRuleClient403 = getRandomVantageClientAllFields();
    private static final ClientHelper enoughTradesRuleClient404 = getRandomVantageClientAllFields();
    private static final ClientHelper enoughTradesRuleClient405 = getRandomVantageClientAllFields();
    private static final ClientHelper enoughTradesRuleClient406 = getRandomVantageClientAllFields();
    ...
    private static final ClientHelper enoughTradesRuleClient28 = getRandomVantageClientAllFields();
    ...
    private static final ClientHelper enoughTradesRuleClientAlert4 = getRandomVantageClientAllFields();
    ...
    private static DataHelper getEnoughTradesTest401Data() {
        DataHelper data = getEnoughTradesRuleData(enoughTradesRuleClient401);
        return data;
    }

    private static DataHelper getEnoughTradesTest402Data() {
        DataHelper data = getEnoughTradesRuleData(enoughTradesRuleClient402);
        return data;
    }

    private static DataHelper getEnoughTradesTest403Data() {
        DataHelper data = getEnoughTradesRuleData(enoughTradesRuleClient403);
        return data;
    }

    private static DataHelper getEnoughTradesTest404Data() {
        DataHelper data = getEnoughTradesRuleData(enoughTradesRuleClient404);
        return data;
    }

    private static DataHelper getEnoughTradesTest405Data() {
        DataHelper data = getEnoughTradesRuleData(enoughTradesRuleClient405);
        return data;
    }

    private static DataHelper getEnoughTradesTest406Data() {
        DataHelper data = getEnoughTradesRuleData(enoughTradesRuleClient406);
        return data;
    }
    ...
    private static DataHelper getEnoughTradesTest28Data() {
        DataHelper data = getEnoughTradesRuleData(enoughTradesRuleClient28);
        data.crmWithdrawalEventV2.setWithdrawalAmountUSD(1000.0);
        CrmTbWithdrawalEntity withdrawal1 = generateCrmTbWithdrawalEntityByClient(data.clientHelper);
        CrmTbWithdrawalEntity withdrawal2 = generateCrmTbWithdrawalEntityByClient(data.clientHelper);
        CrmTbWithdrawalEntity withdrawal3 = generateCrmTbWithdrawalEntityByClient(data.clientHelper);
        ...
        paymentDecisionsObject1.setDecisionCode(2);
    ...
    private static DataHelper getEnoughTradesTestAlert4Data() {
        DataHelper data = getEnoughTradesRuleData(enoughTradesRuleClientAlert4);
        data.crmWithdrawalEventV2.setWithdrawalAmountUSD(1000.0);
        CrmTbWithdrawalEntity withdrawal1 = generateCrmTbWithdrawalEntityByClient(data.clientHelper);
        CrmTbWithdrawalEntity withdrawal2 = generateCrmTbWithdrawalEntityByClient(data.clientHelper);
        CrmTbWithdrawalEntity withdrawal3 = generateCrmTbWithdrawalEntityByClient(data.clientHelper);
    ...
    public static Map<String, DataHelper> setupEnoughTradesRuleData() {
        ...
        map.put("401", getEnoughTradesTest401Data());
        map.put("402", getEnoughTradesTest402Data());
        map.put("403", getEnoughTradesTest403Data());
        map.put("404", getEnoughTradesTest404Data());
        map.put("405", getEnoughTradesTest405Data());
        map.put("406", getEnoughTradesTest406Data());
        ...
        map.put("28", getEnoughTradesTest28Data());
        ...
        map.put("773", getEnoughTradesTestAlert4Data());
