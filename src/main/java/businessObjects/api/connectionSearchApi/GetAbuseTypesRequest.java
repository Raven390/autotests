...
public class GetAbuseTypesRequest {
    ...
    public static Response getAbuseTypesByClientId(Map<String, Object> paramsMap) throws IOException {
        return new HttpHelper().sendGetRequest(CONNECTION_SEARCH_BASE_PATH + CONNECTION_SEARCH_GET_ABUSE_TYPES_BY_CLIENT, null, paramsMap);
    }
    ...
    public static Response getAbuseTypesByAttributes(Map<String, Object> paramsMap) throws IOException {
        return new HttpHelper().sendGetRequest(CONNECTION_SEARCH_BASE_PATH + CONNECTION_SEARCH_GET_ABUSE_TYPES_BY_ATTRIBUTES, null, paramsMap);
    }
