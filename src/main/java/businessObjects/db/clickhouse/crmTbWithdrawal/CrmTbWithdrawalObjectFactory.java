...
public class CrmTbWithdrawalObjectFactory {
    ...
    public static CrmTbWithdrawalObject generateStaticWithdrawalByClient(ClientHelper client, String paymentType,
            int counter) {
        return new CrmTbWithdrawalObject(
                1, 1, client.getBrand(), client.getRegulator(), client.getUserId(), client.getUcid(), client.getTradingAccount(), (client.getUserId() * 100) + counter, "2024-09-13 12:03:12.084000000", "2024-09-13 12:03:12.084000000", "2024-09-13 12:03:12.084000000", "2024-09-13 12:03:12.084000000", "2024-09-13 12:03:12.084000000", "2024-09-13 12:03:12.084000000", 1.0, 2.0, 3.0, 4.0, "USD", 1, "Audit", 1, paymentType, 1, "paymentChannel", "paymentSystemAccount", "EUR", "paymentDetails", "2024-09-13 12:03:12.084000000", (client.getUserId() * 100) + counter, 0.1, "processedNotes", 1, 1, 1, "2024-09-13 12:03:12.084000000"
        );
    }
}
