...
class ConnectionSearchProductionSmokeTests {
    ...
    void testConnectionSearchProd1() throws IOException {
        ...
        Response response = new HttpHelper()
                .sendGetRequest(
                        CONNECTION_SEARCH_BASE_PATH_PROD + CONNECTION_SEARCH_GET_ABUSE_TYPES_BY_ATTRIBUTES,
                        null,
                        queryParams);
    ...
    void testConnectionSearchProd2() throws IOException {
        ...
        Response response = new HttpHelper()
                .sendGetRequest(
                        CONNECTION_SEARCH_BASE_PATH_PROD + CONNECTION_SEARCH_GET_ABUSE_TYPES_BY_CLIENT_V1,
                        null,
                        queryParams);
        assertThat("Check the response code is 200", response.code(), is(200));
    }
    ...
    void testConnectionSearchProd3() throws IOException {
        ...
        Response response = new HttpHelper()
                .sendGetRequest(
                        CONNECTION_SEARCH_BASE_PATH_PROD + CONNECTION_SEARCH_GET_CONNECTIONS_BY_CLIENT,
                        null,
                        queryParams);
        assertThat("Check the response code is 200", response.code(), is(200));
    }
    ...
    void testConnectionSearchProd4() throws IOException {
        ...
        Response response = new HttpHelper()
                .sendGetRequest(
                        CONNECTION_SEARCH_BASE_PATH_PROD + CONNECTION_SEARCH_GET_CONNECTIONS_BY_ATTRIBUTES,
                        null,
                        queryParams);
        assertThat("Check the response code is 200", response.code(), is(200));
    }
    ...
    void testConnectionSearchProd5() throws IOException {
        ...
        Response response = new HttpHelper()
                .sendGetRequest(
                        CONNECTION_SEARCH_BASE_PATH_PROD + CONNECTION_SEARCH_GET_CHECK_CONNECTED_IB, null, queryParams);
        assertThat("Check the response code is 200", response.code(), is(200));
    }
}
