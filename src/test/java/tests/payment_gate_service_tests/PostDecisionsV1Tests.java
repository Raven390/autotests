...
class PostDecisionsV1Tests extends TestBaseApi {
    ...
    static PostDecisionsRequestBody postPaymentDecisionBody1;
    static PostDecisionsRequestBody postPaymentDecisionBody2;
    static PostDecisionsRequestBody postPaymentDecisionBody3;
    static PostDecisionsRequestBody postPaymentDecisionBody4;
    static PostDecisionsRequestBody postPaymentDecisionBody5;
