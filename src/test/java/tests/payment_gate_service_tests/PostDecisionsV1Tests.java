...
class PostDecisionsV1Tests extends TestBaseApi {
    ...
    static void deleteData() throws Exception {
        ...
        cleanPaymentGateData(
                client6.getUcid(),
                client6.getUserId(),
                paymentEventsObject6.getPaymentId().toString());
        cleanPaymentGateData(
                client7.getUcid(),
                client7.getUserId(),
                paymentEventsObject7.getPaymentId().toString());
    }
    ...
    void PostPaymentDecisionV1Test1() throws Exception {
        ...
        Response response =
                postDecisions(paymentEventsObject1.getPaymentId().toString(), List.of(postPaymentDecisionBody1));
        ...
        assertThat(
                "Check response", mappedResponse[0].getDecisionType(), is(postPaymentDecisionBody1.getDecisionType()));
        assertThat(
                "Check response", mappedResponse[0].getDecisionCode(), is(postPaymentDecisionBody1.getDecisionCode()));
    ...
    void PostPaymentDecisionV1Test2() throws Exception {
        ...
        Response response = postDecisions(
                paymentEventsObject2.getPaymentId().toString(),
                List.of(postPaymentDecisionBody2, postPaymentDecisionBody3));
        assertThat(response.code(), is(201));
    ...
    void PostPaymentDecisionV1Test3() throws Exception {
        ...
        Response response =
                postDecisions(paymentEventsObject4.getPaymentId().toString(), List.of(postPaymentDecisionBody4));
        ...
        assertThat(
                ...
                containsString("createPaymentDecisions.paymentDecisionRequest[0].decisionType: must not be null"));
    }
    ...
    void PostPaymentDecisionV1Test4() throws Exception {
        ...
        Response response = postDecisions(
                paymentEventsObject4.getPaymentId().toString(),
                List.of(postPaymentDecisionBody5, postPaymentDecisionBody5));
    ...
    void PostPaymentDecisionV1Test5() throws Exception {
        ...
        Allure.step("send post decisions request with valid data");
        Response response =
                postDecisions(paymentEventsObject3.getPaymentId().toString(), List.of(postPaymentDecisionBody3));
        assertThat(response.code(), is(201));
        ...
        assertThat(
                "Check response", mappedResponse[0].getDecisionType(), is(postPaymentDecisionBody3.getDecisionType()));
        assertThat(
                "Check response", mappedResponse[0].getDecisionCode(), is(postPaymentDecisionBody3.getDecisionCode()));
