...
class PutRuleExecutionsV1Tests extends TestBaseApi {
    ...
    static void deleteData() throws Exception {
        ...
        CleanTableHelper.cleanPaymentGateData(client3.getUcid(), client3.getUserId(), putRuleExecutionsBody3.getPaymentId().toString());
        CleanTableHelper.cleanPaymentGateData(client4.getUcid(), client4.getUserId(), putRuleExecutionsBody4.getPaymentId().toString());
    }
    ...
    void PutRuleExecutionsV1Test1() throws Exception {
        ...
        PutExecutionsResponseBody mappedResponse = objectMapper.readValue(response.body().string(), PutExecutionsResponseBody.class);
    ...
    void PutRuleExecutionsV1Test2() throws Exception {
        ...
        assertThat("Assert message", mappedResponse.getMessage(), is("Payment not found with ID: " + putRuleExecutionsBody2.getPaymentId()));
    }
    ...
    void PutRuleExecutionsV1Test3() throws Exception {
        ...
        Allure.step("Validate Data in response");
        PutExecutionsResponseBody mappedResponse2 = objectMapper.readValue(response2.body().string(), PutExecutionsResponseBody.class);
