...
public class TradingInfoAccountsTest extends TestBaseWeb {
    ...
    public void verifyAccountsCardViewTest() {
        ...
        assertThat("Assert that account status in card view is as expected", tradingPage.getAccountStatus(account1.account), equalTo(account1.status));
        ...
        assertThat("Assert that account type in card view is as expected", tradingPage.getAccountType(account1.account), equalTo(account1.type));
        ...
        assertThat("Assert that account created time in card view is as expected", tradingPage.getAccountCreatedTime(account1.account), equalTo(account1.createdDate));
        ...
        assertThat("Assert that account status in card view is as expected", tradingPage.getAccountStatus(account2.account), equalTo(account2.status));
        ...
        assertThat("Assert that account type in card view is as expected", tradingPage.getAccountType(account2.account), equalTo(account2.type));
        ...
        assertThat("Assert that account created time in card view is as expected", tradingPage.getAccountCreatedTime(account2.account), equalTo(account2.createdDate));
    ...
    public void verifyAccountsTableViewTest() {
        ...
        assertThat("Assert that account status in table view is as expected", tradingPage.getAccountTableStatus(account1.account), equalTo(account1.status));
        assertThat("Assert that account created time in table view is as expected", tradingPage.getAccountTableCreated(account1.account), equalTo(account1.createdDate.replace(" ", "")));
        ...
        assertThat("Assert that account type in table view is as expected", tradingPage.getAccountTableType(account2.account), equalTo(account2.type));
        assertThat("Assert that account status in table view is as expected", tradingPage.getAccountTableStatus(account2.account), equalTo(account2.status));
        assertThat("Assert that account created time in table view is as expected", tradingPage.getAccountTableCreated(account2.account), equalTo(account2.createdDate.replace(" ", "")));
