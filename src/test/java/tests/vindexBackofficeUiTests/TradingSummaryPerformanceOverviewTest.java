...
public class TradingSummaryPerformanceOverviewTest extends TestBaseWeb {
    ...
    public static void setup() throws ReflectiveOperationException, SQLException, JsonProcessingException {
        ...
        trade3.openTimeUtc = getCurrentTimestampMinusOffsetFormatted(DATE_AND_TIME, 0, 0, 0, 0, 5);
        ...
        trade7.openTimeUtc = getCurrentTimestampMinusOffsetFormatted(DATE_AND_TIME, 0, 0, 0, 0, 5);
        trade8.symbol = "GBPJPY";
        trade8.profitUsd = 1056d;
        trade8.storageUsd = 256d;
        trade8.commissionUsd = 11.33d;
        trade8.openTimeUtc = getCurrentTimestampMinusOffsetFormatted(DATE_AND_TIME, 0, 0, 0, 0, 5);
        trade9.symbol = "GBPJPY";
        trade9.profitUsd = 1056d;
        trade9.storageUsd = 256d;
        trade9.commissionUsd = 111.33d;
        trade9.openTimeUtc = getCurrentTimestampMinusOffsetFormatted(DATE_AND_TIME, 0, 0, 0, 0, 5);
