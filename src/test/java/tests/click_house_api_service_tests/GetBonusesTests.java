...
class GetBonusesTests extends TestBaseApi {
    ...
    void getBonusesAllParamsTest() throws IOException {
        ...
        GetBonusesResponse[] mappedResponse =
                objectMapper.readValue(response.body().string(), GetBonusesResponse[].class);
    ...
    void getBonusesNoParamsTest() throws IOException {
        ...
        assertThat(
                ...
                is("Required request parameter 'clientIds' for method parameter type List is not present"));
    ...
    void getBonusesIncorrectOrderByTest() throws IOException {
        ...
        assertThat(
                ...
                mappedResponse.getError(),
                is(
                        "Invalid &quot;orderBy&quot; property format. The property may include only: clientId, createTime, actualAmount, actualAmountUSD"));
