...
class GetSymbolGroupsTests extends TestBaseApi {
    ...
    void getSymbolGroupsTest2() throws IOException {
        ...
        assertThat("Error key should be present", mappedResponse.getError(), is("Required request parameter 'symbol' for method parameter type String is not present"));
    ...
    void getSymbolGroupsTest3() throws IOException {
        ...
        assertThat("Error key should be present", mappedResponse.getError(), is("SymbolGroup data is not found for the request with parameters: {symbol=ACVKSJ}."));
