...
class GetClientTradingAccountTests extends TestBaseApi {
    ...
    static void setup() {
        insertObjectsToDb(
                ...
                List.of(generateCrmTbAccountData(client), generateAdditionalCrmTbAccountData(client)));
    }
    ...
    void getClientTradingAccountsTest1() throws IOException {
        ...
        List<GetClientTradingAccountsResponse> mappedResponse = Arrays.stream(
                        objectMapper.readValue(response.body().string(), GetClientTradingAccountsResponse[].class))
                .toList();
    ...
    void getClientTradingAccountsTest2() throws IOException {
        ...
        assertThat(
                ...
                is(
                        "Invalid clientId format: clientId must contain brand and userId divided by a dash e.g., vantage-2068746030"));
    }
}
