...
class GetCreditEquityRatioTests extends TestBaseApi {
    ...
    void getCreditEquityRatioTest1() throws IOException {
        ...
        GetCreditEquityResponse mappedResponse =
                objectMapper.readValue(response.body().string(), GetCreditEquityResponse.class);
        ...
        assertThat(
                ...
                mappedResponse.tradingIndicators.getFirst().indicatorDate,
                is("2024-12-31T00:00"));
        assertThat(
                "Assert tradingIndicators currentEquity",
                mappedResponse.tradingIndicators.getFirst().currentEquity,
                is("0"));
        ...
        assertThat(
                ...
                is("2024-12-31T00:00"));
        assertThat(
                "Assert tradingIndicators creditEquityRatio",
                mappedResponse.tradingIndicators.get(2).creditEquityRatio,
                is("0"));
    }
    ...
    void getCreditEquityRatioTest4() throws IOException {
        ...
        assertThat(
                "Assert that code is 200",
                response.body().string(),
                containsString(
                        "Required request parameter 'dateTo' for method parameter type LocalDateTime is not present"));
    }
