...
class GetSwapFreeFeesTests extends TestBaseApi {
    ...
    void getSwapFreeFeesTest1() throws IOException {
        ...
        List<GetSwapFreeFeesResponse> mappedResponse = Arrays.stream(
                        objectMapper.readValue(response.body().string(), GetSwapFreeFeesResponse[].class))
                .toList();
        GetSwapFreeFeesResponse response1 = new GetSwapFreeFeesResponse(
                formatTimeToUtc(tradeDate1), data1.ticket, client1.getTradingAccount(), 1d, 2d, comment);
        GetSwapFreeFeesResponse response2 = new GetSwapFreeFeesResponse(
    ...
    void getSwapFreeFeesTest2() throws IOException {
        ...
        assertThat(response.body(), is(notNullValue()));
        GetSwapFreeFeesResponse[] mappedResponse =
                objectMapper.readValue(response.body().string(), GetSwapFreeFeesResponse[].class);
