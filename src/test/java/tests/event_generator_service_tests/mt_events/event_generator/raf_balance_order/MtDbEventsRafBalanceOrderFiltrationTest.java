...
class MtDbEventsRafBalanceOrderFiltrationTest extends TestBaseKafka {
    ...
    void generateRafBalanceOrderEventsAndVerifyTheyWereFilteredOutTest() throws JsonProcessingException {
        ...
        rafBalanceOrderEventTradeIdAccountServerId2
                .getData()
                .setTradeId(
                        rafBalanceOrderEventTradeIdAccountServerId1.getData().getTradeId());
        rafBalanceOrderEventTradeIdAccountServerId2
                .getData()
                .setMtAccount(
                        rafBalanceOrderEventTradeIdAccountServerId1.getData().getMtAccount());
        ...
        kafka.produceMessages(
                ...
                objectMapper.writeValueAsString(rafBalanceOrderEventTestAccount1),
                objectMapper.writeValueAsString(rafBalanceOrderEventTestAccount2),
                ...
                objectMapper.writeValueAsString(rafBalanceOrderEventMt4Cmd1),
                objectMapper.writeValueAsString(rafBalanceOrderEventMt4Cmd2),
                objectMapper.writeValueAsString(rafBalanceOrderEventMt4Comment),
                objectMapper.writeValueAsString(rafBalanceOrderEventMt5Action1),
                objectMapper.writeValueAsString(rafBalanceOrderEventMt5Action2));

        Allure.step("Wait for event generator do some magic and consume message from crm-events topic");
        MatchResultWithMessage isAnyMatchPresentInMessages = kafka.isAnyMatchPresentInMessages(
                KAFKA_TOPIC_MT_EVENTS,
                rafBalanceOrderEventTestAccount1.getData().getOpenTime(),
                rafBalanceOrderEventTestAccount2.getData().getOpenTime(),
                rafBalanceOrderEventTradeIdAccountServerId2.getData().getOpenTime(),
                rafBalanceOrderEventMt4Cmd1.getData().getOpenTime(),
                rafBalanceOrderEventMt4Cmd2.getData().getOpenTime(),
                rafBalanceOrderEventMt4Comment.getData().getOpenTime(),
                rafBalanceOrderEventMt5Action1.getData().getOpenTime(),
                rafBalanceOrderEventMt5Action2.getData().getOpenTime());
