...
class CloseTradeMt4EventFiltrationTests extends TestBaseKafka {
    ...
    @AllureId("1161")
    @DisplayName(
            "MT4 close trade event passing filtering. msg_type = ‘trade_record’, operation = 1, mode = 2, close_time > 0, cmd = 0")
    ...
    @AllureId("1162")
    @DisplayName(
            "MT4 close trade event passing filtering. msg_type = ‘trade_record’, operation = 1, mode = 2, close_time > 0, cmd = 1")
