...
class StopoutMt4FilteringTests extends TestBaseKafka {
    ...
    @AllureId("1229")
    @Tag("CSV-1280")
    @DisplayName("MT4 stopout close trade event passing filtering. msg_type = ‘trade_record’, operation = 1, mode = 2, close_time > 0, cmd = 0, comment contains 'so'")
    ...
    @AllureId("1230")
    @Tag("CSV-1280")
    @DisplayName("MT4 stopout close trade event passing filtering. msg_type = ‘trade_record’, operation = 1, mode = 2, close_time > 0, cmd = 1, comment contains 'so'")
    ...
    @AllureId("1231")
    @Tag("CSV-1280")
    @DisplayName("MT4 stopout close trade event passing filtering. msg_type = ‘trade_record1’, operation = 1, mode = 2, close_time > 0, cmd = 0, comment contains 'so'")
    ...
    @AllureId("1232")
    @Tag("CSV-1280")
    @DisplayName("MT4 stopout close trade event passing filtering. msg_type = ‘trade_record’, operation = 0, mode = 2, close_time > 0, cmd = 0, comment contains 'so'")
    ...
    @AllureId("1233")
    @Tag("CSV-1280")
    @DisplayName("MT4 stopout close trade event passing filtering. msg_type = ‘trade_record’, operation = 1, mode = 3, close_time > 0, cmd = 0, comment contains 'so'")
    ...
    @AllureId("1235")
    @Tag("CSV-1280")
    @DisplayName("MT4 stopout close trade event passing filtering. msg_type = ‘trade_record’, operation = 1, mode = 2, close_time > 0, cmd = 2, comment contains 'so'")
    ...
    @AllureId("1236")
    @Tag("CSV-1280")
    @DisplayName("MT4 stopout close trade event passing filtering. msg_type = ‘trade_record’, operation = 1, mode = 2, close_time > 0, cmd = 0, comment contains 'so1'")
