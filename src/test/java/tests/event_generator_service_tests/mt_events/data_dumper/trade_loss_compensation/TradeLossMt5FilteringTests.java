...
class TradeLossMt5FilteringTests extends TestBaseKafka {
    ...
    @AllureId("1282")
    @Tag("CSV-1280")
    @DisplayName("MT5 trade loss event passing filtering. MsgType = ‘Deal’, Operation = 0, Entry = 1, Action=0, Comment contains 'Trade Loss'")
    void filtrationMt5TradeLossEventTest1() throws JsonProcessingException {
        ...
        tradeLossMt5.getHeader().setMsgType("Deal");
        ...
        kafka.produceMessage(KAFKA_MESSAGE_KEY, objectMapper.writeValueAsString(tradeLossMt5), KAFKA_TOPIC_MT_5_DEAL);
    ...
    @AllureId("1283")
    @Tag("CSV-1280")
    @DisplayName("MT5 trade loss event passing filtering. MsgType = ‘Deal’, Operation = 0, Entry = 3, Action=2, Comment contains 'TLV'")
    ...
    @AllureId("1285")
    @Tag("CSV-1280")
    @DisplayName("MT5 trade loss event not passing filtering. MsgType = ‘Deal’, Operation = 1, Entry = 1, Action=2, Comment contains 'Trade Loss'")
    ...
    @AllureId("1286")
    @Tag("CSV-1280")
    @DisplayName("MT5 trade loss event not  passing filtering. MsgType = ‘Deal’, Operation = 0, Entry = 2, Action=2, Comment contains 'Trade Loss'")
    ...
    @AllureId("1287")
    @Tag("CSV-1280")
    @DisplayName("MT5 trade loss event not passing filtering. MsgType = ‘Deal’, Operation = 0, Entry = 1, Action=3, Comment contains 'Trade Loss'")
    ...
    @AllureId("1288")
    @Tag("CSV-1280")
    @DisplayName("MT5 trade loss event not passing filtering. MsgType = ‘Deal’, Operation = 0, Entry = 1, Action=2, Comment contains 'Trade Los'")
