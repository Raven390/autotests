...
class TradeLossMt5FilteringTests extends TestBaseKafka {
    ...
    @Tag("CSV-1280")
    @DisplayName(
            "MT5 trade loss event passing filtering. MsgType = ‘DealPerform’, Operation = 0, Entry = 1, Action=0, Comment contains 'Trade Loss'")
    void filtrationMt5TradeLossEventTest1() throws JsonProcessingException {
        ...
        kafka.produceMessage(
                KAFKA_MESSAGE_KEY, objectMapper.writeValueAsString(tradeLossMt5), KAFKA_TOPIC_MT_5_DEAL_PERFORM);
    ...
    @Tag("CSV-1280")
    @DisplayName(
            "MT5 trade loss event passing filtering. MsgType = ‘DealPerform’, Operation = 0, Entry = 3, Action=2, Comment contains 'TLV'")
    ...
    @Tag("CSV-1280")
    @DisplayName(
            "MT5 trade loss event not passing filtering. MsgType = ‘Deal1’, Operation = 0, Entry = 1, Action=2, Comment contains 'Trade Loss'")
    ...
    @Tag("CSV-1280")
    @DisplayName(
            "MT5 trade loss event not passing filtering. MsgType = ‘DealPerform’, Operation = 1, Entry = 1, Action=2, Comment contains 'Trade Loss'")
    ...
    @Tag("CSV-1280")
    @DisplayName(
            "MT5 trade loss event not  passing filtering. MsgType = ‘DealPerform’, Operation = 0, Entry = 2, Action=2, Comment contains 'Trade Loss'")
    ...
    @Tag("CSV-1280")
    @DisplayName(
            "MT5 trade loss event not passing filtering. MsgType = ‘DealPerform’, Operation = 0, Entry = 1, Action=3, Comment contains 'Trade Loss'")
    ...
    @Tag("CSV-1280")
    @DisplayName(
            "MT5 trade loss event not passing filtering. MsgType = ‘DealPerform’, Operation = 0, Entry = 1, Action=2, Comment contains 'Trade Los'")
