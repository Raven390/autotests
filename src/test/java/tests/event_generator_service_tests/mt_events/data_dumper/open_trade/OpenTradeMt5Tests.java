...
class OpenTradeMt5Tests extends TestBaseKafka {
    ...
    @AllureId("1212")
    @Tag("CSV-1280")
    @DisplayName("Generate open trade event (action = 0) with event generator service from MT5 data dumper source with all fields populated")
    ...
    @AllureId("1329")
    @Tag("CSV-1280")
    @DisplayName("Generate open trade event (action = 1) with event generator service from MT5 data dumper source with all fields populated")
