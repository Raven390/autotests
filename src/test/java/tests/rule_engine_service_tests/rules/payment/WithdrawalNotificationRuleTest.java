...
import helpers.data.rules.MirrorFlagDataInserter;
...
class WithdrawalNotificationRuleTest extends TestBaseRule {
    ...
    static void deleteData() throws Exception {
        ...
        MirrorFlagDataInserter.deleteData(client3);
        stopSshTunnel();
    }
    ...
    void withdrawalNotificationRule1Test() throws Exception {
        ...
        List<Alert> dbAlerts = getUserAlertsFromDb(client1, "Withdrawal Review");
    ...
    @Test
    @AllureId("")
    @DisplayName("Withdrawal notification rule. Exit with alert if withdrawal has not empty check name and 'Crypto_Risk' mirror flag = true. ElementId: Event_0go9648")
    void withdrawalNotificationRule3Test() throws Exception {
        client3.setServerId(4);
        CrmWithdrawalEvent withdrawalEvent = new CrmWithdrawalEvent(
                "MT4",                   // accountType
                "486951",                            // binNumber
    ...
    void withdrawalNotificationRule4Test() throws Exception {
        ...
        assertThat("Verify orderNumber in Kafka topic", approval.getFirst().getOrderNumber(), is(withdrawalEvent.getMerchantOrderId()));
    }
}
