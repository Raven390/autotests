...
class LoginRuleTests extends TestBaseRule {
    ...
    void loginRuleTest8() throws Exception {
        ...
        assertThat("Verify that there is only 1 restriction", clientGeneralRestrictions.size(), equalTo(2));
        ...
        assertThat("Check restrictionId", clientGeneralRestrictions.get(0).getRestrictionId(), is(9L));
        //assertThat("Check comment", clientGeneralRestrictions.get(0).getComment(), is("Mirror trade pattern"));
        assertThat("Check status", clientGeneralRestrictions.get(0).getStatus(), is("APPLIED"));
        //Check second restriction
        assertThat("Check ucid", clientGeneralRestrictions.get(1).getUcid(), is(data.clientHelper.getUcid()));
        assertThat("Check regulator", clientGeneralRestrictions.get(1).getRegulator(), is(data.clientHelper.getRegulator()));
        assertThat("Check restrictionId", clientGeneralRestrictions.get(1).getRestrictionId(), is(8L));
        assertThat("Check comment", clientGeneralRestrictions.get(1).getComment(), is("Linked abuser"));
        assertThat("Check status", clientGeneralRestrictions.get(1).getStatus(), is("APPLIED"));
