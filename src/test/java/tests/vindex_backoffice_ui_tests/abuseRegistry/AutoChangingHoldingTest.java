...
class AutoChangingHoldingTest extends TestBaseWeb {
    ...
    void holdingSchedulerTest1() throws Exception {
        holdingDeduction1 = generateAbuserDeductionByAccount(account1, abuserHistory.getLast().getId());
        ...
        holdingDeduction1.setIllegalProfit(mtAccount1.balance + withdrawal.amount);
        holdingDeduction1.setIllegalProfitUsd(mtAccount1.balanceUsd + withdrawal.amountUsd);
        ...
        holdingDeduction1.setBalanceAtResolution(mtAccount1.balance);
        holdingDeduction1.setBalanceAtResolutionUsd(mtAccount1.balanceUsd);
        ...
        for (int i = 0; i < 10; i++) {
            deductionList = getObjectsFromDB(DbName.POSTGRES, AR_ABUSER_DEDUCTION_TABLE_NAME, String.format("ucid = '%s'", client.getUcid()), AbuserDeduction.class);
            if (deductionList.size() <= 1) {
                Thread.sleep(2000);
                if (i == 9) {
                    assertThat("The holding scheduler did not recalculate deductions in 20 sec", deductionList.size(), greaterThan(1));
                }
            } else {
                break;
            }
        ...
        for (AbuserDeduction deduction : deductionList) {
            assertThat("Verify created deduction has abuser_history_id not null", deduction.getAbuserHistoryId(), is(deduction.getAbuserHistoryId()));
            assertThat("Verify created deduction has illegal_profit_usd not null", deduction.getIllegalProfitUsd(), notNullValue());
            assertThat("Verify created deduction has suggested_deduction_usd not null", deduction.getSuggestedDeductionUsd(), notNullValue());
        ...
        AbuserDeduction deduction1 = new AbuserDeduction(client.getUcid(), holdingDeduction1.getAbuserHistoryId(), mtAccount1.account.toString(), mtAccount1.sourceIdSt, mtAccount1.server, mtAccount1.currency, client.getBrand(), WAS_HOLDING.getDisplayName(), NOT_SENT.getDisplayName(), TO_BE_DEDUCTED.getDisplayName(), AWAITING_APPROVAL.getDisplayName(), holdingDeduction1.getComment(), mtAccount1.balance + withdrawal.amount, null, mtAccount1.balance, null, null, null, null, null, String.format("%s %s", autotestUserOne().getFirstName(), autotestUserOne().getLastName()), VINDEX_BO_SYSTEM, ILLEGAL_PROFIT.getDisplayName(), null, holdingDeduction1.getCommentDeduction(), mtAccount1.balance, null, client.getUserId().toString(), mtAccount1.balance, null, false);
        AbuserDeduction deduction2 = new AbuserDeduction(client.getUcid(), holdingDeduction1.getAbuserHistoryId(), mtAccount5.account.toString(), mtAccount5.sourceIdSt, mtAccount5.server, mtAccount5.currency, client.getBrand(), NOT_HOLDING.getDisplayName(), NOT_SENT.getDisplayName(), TO_BE_DEDUCTED.getDisplayName(), AWAITING_APPROVAL.getDisplayName(), holdingDeduction1.getComment(), 0d, null, mtAccount5.balance, null, null, null, null, null, String.format("%s %s", autotestUserOne().getFirstName(), autotestUserOne().getLastName()), VINDEX_BO_SYSTEM, NO_ILLEGAL_PROFIT.getDisplayName(), null, holdingDeduction1.getCommentDeduction(), mtAccount5.balance, null, client.getUserId().toString(), null, null, false);
        AbuserDeduction deduction3 = new AbuserDeduction(client.getUcid(), holdingDeduction1.getAbuserHistoryId(), mtAccount4.account.toString(), mtAccount4.sourceIdSt, mtAccount4.server, mtAccount4.currency, client.getBrand(), NOT_HOLDING.getDisplayName(), NOT_SENT.getDisplayName(), TO_BE_DEDUCTED.getDisplayName(), AWAITING_APPROVAL.getDisplayName(), holdingDeduction1.getComment(), 0d, null, mtAccount4.balance, null, null, null, null, null, String.format("%s %s", autotestUserOne().getFirstName(), autotestUserOne().getLastName()), VINDEX_BO_SYSTEM, NO_ILLEGAL_PROFIT.getDisplayName(), null, holdingDeduction1.getCommentDeduction(), mtAccount4.balance, null, client.getUserId().toString(), null, null, false);
        AbuserDeduction deduction5 = new AbuserDeduction(client.getUcid(), holdingDeduction1.getAbuserHistoryId(), mtAccount2.account.toString(), mtAccount2.sourceIdSt, mtAccount2.server, mtAccount2.currency, client.getBrand(), NOT_HOLDING.getDisplayName(), NOT_SENT.getDisplayName(), TO_BE_DEDUCTED.getDisplayName(), AWAITING_APPROVAL.getDisplayName(), holdingDeduction1.getComment(), 0d, null, mtAccount2.balance, null, null, null, null, null, String.format("%s %s", autotestUserOne().getFirstName(), autotestUserOne().getLastName()), VINDEX_BO_SYSTEM, NO_ILLEGAL_PROFIT.getDisplayName(), null, holdingDeduction1.getCommentDeduction(), mtAccount2.balance, null, client.getUserId().toString(), null, null, false);
        AbuserDeduction deduction4 = new AbuserDeduction(client.getUcid(), holdingDeduction1.getAbuserHistoryId(), mtAccount3.account.toString(), mtAccount3.sourceIdSt, mtAccount3.server, mtAccount3.currency, client.getBrand(), HOLDING.getDisplayName(), NOT_SENT.getDisplayName(), TO_BE_DEDUCTED.getDisplayName(), AWAITING_APPROVAL.getDisplayName(), holdingDeduction1.getComment(), 0d, null, 0d, null, null, null, null, null, String.format("%s %s", autotestUserOne().getFirstName(), autotestUserOne().getLastName()), VINDEX_BO_SYSTEM, NO_ILLEGAL_PROFIT.getDisplayName(), null, holdingDeduction1.getCommentDeduction(), 0d, null, client.getUserId().toString(), null, null, false);
    ...
    void holdingSchedulerTest2() throws Exception {
        ...
        List<AbuserDeduction> deductionList = new ArrayList<>();
        for (int i = 0; i < 10; i++) {
            deductionList = getObjectsFromDB(DbName.POSTGRES, AR_ABUSER_DEDUCTION_TABLE_NAME, String.format("account = '%s'", mtAccount3.account), AbuserDeduction.class);
            if (!Objects.equals(deductionList.getFirst().getStatusOpenPositions(), WAS_HOLDING.getDisplayName())) {
                Thread.sleep(2000);
                if (i == 9) {
                    assertThat("The holding scheduler did not recalculate deductions in 20 sec", deductionList.getFirst().getStatusOpenPositions(), is(WAS_HOLDING.getDisplayName()));
                }
            } else {
                break;
            }
        ...
        AbuserDeduction deduction1 = new AbuserDeduction(client.getUcid(), holdingDeduction1.getAbuserHistoryId(), mtAccount1.account.toString(), mtAccount1.sourceIdSt, mtAccount1.server, mtAccount1.currency, client.getBrand(), WAS_HOLDING.getDisplayName(), NOT_SENT.getDisplayName(), TO_BE_DEDUCTED.getDisplayName(), AWAITING_APPROVAL.getDisplayName(), holdingDeduction1.getComment(), mtAccount1.balance + withdrawal.amount, null, mtAccount1.balance, null, null, null, null, null, String.format("%s %s", autotestUserOne().getFirstName(), autotestUserOne().getLastName()), VINDEX_BO_SYSTEM, ILLEGAL_PROFIT.getDisplayName(), null, holdingDeduction1.getCommentDeduction(), mtAccount1.balance, null, client.getUserId().toString(), mtAccount1.balance, mtAccount1.balance, false);
        AbuserDeduction deduction2 = new AbuserDeduction(client.getUcid(), holdingDeduction1.getAbuserHistoryId(), mtAccount5.account.toString(), mtAccount5.sourceIdSt, mtAccount5.server, mtAccount5.currency, client.getBrand(), NOT_HOLDING.getDisplayName(), NOT_SENT.getDisplayName(), TO_BE_DEDUCTED.getDisplayName(), AWAITING_APPROVAL.getDisplayName(), holdingDeduction1.getComment(), 0d, null, mtAccount5.balance, null, null, null, null, null, String.format("%s %s", autotestUserOne().getFirstName(), autotestUserOne().getLastName()), VINDEX_BO_SYSTEM, NO_ILLEGAL_PROFIT.getDisplayName(), null, holdingDeduction1.getCommentDeduction(), mtAccount5.balance, null, client.getUserId().toString(), mtAccount5.balance, null, false);
        AbuserDeduction deduction3 = new AbuserDeduction(client.getUcid(), holdingDeduction1.getAbuserHistoryId(), mtAccount4.account.toString(), mtAccount4.sourceIdSt, mtAccount4.server, mtAccount4.currency, client.getBrand(), NOT_HOLDING.getDisplayName(), NOT_SENT.getDisplayName(), TO_BE_DEDUCTED.getDisplayName(), AWAITING_APPROVAL.getDisplayName(), holdingDeduction1.getComment(), 0d, null, mtAccount4.balance, null, null, null, null, null, String.format("%s %s", autotestUserOne().getFirstName(), autotestUserOne().getLastName()), VINDEX_BO_SYSTEM, NO_ILLEGAL_PROFIT.getDisplayName(), null, holdingDeduction1.getCommentDeduction(), mtAccount4.balance, null, client.getUserId().toString(), mtAccount4.balance, null, false);
        AbuserDeduction deduction5 = new AbuserDeduction(client.getUcid(), holdingDeduction1.getAbuserHistoryId(), mtAccount2.account.toString(), mtAccount2.sourceIdSt, mtAccount2.server, mtAccount2.currency, client.getBrand(), NOT_HOLDING.getDisplayName(), NOT_SENT.getDisplayName(), TO_BE_DEDUCTED.getDisplayName(), AWAITING_APPROVAL.getDisplayName(), holdingDeduction1.getComment(), 0d, null, mtAccount2.balance, null, null, null, null, null, String.format("%s %s", autotestUserOne().getFirstName(), autotestUserOne().getLastName()), VINDEX_BO_SYSTEM, NO_ILLEGAL_PROFIT.getDisplayName(), null, holdingDeduction1.getCommentDeduction(), mtAccount2.balance, null, client.getUserId().toString(), mtAccount2.balance, null, false);
        AbuserDeduction deduction4 = new AbuserDeduction(client.getUcid(), holdingDeduction1.getAbuserHistoryId(), mtAccount3.account.toString(), mtAccount3.sourceIdSt, mtAccount3.server, mtAccount3.currency, client.getBrand(), WAS_HOLDING.getDisplayName(), NOT_SENT.getDisplayName(), TO_BE_DEDUCTED.getDisplayName(), AWAITING_APPROVAL.getDisplayName(), holdingDeduction1.getComment(), 0d, null, mtAccount3.balance, null, null, null, null, null, String.format("%s %s", autotestUserOne().getFirstName(), autotestUserOne().getLastName()), VINDEX_BO_SYSTEM, NO_ILLEGAL_PROFIT.getDisplayName(), null, holdingDeduction1.getCommentDeduction(), mtAccount3.balance, null, client.getUserId().toString(), mtAccount3.balance, null, false);
        assertThat("Verify deductions in abuser_deduction table are as expected", deductionList, containsInAnyOrder(deduction1, deduction2, deduction3, deduction4, deduction5));
    }
    ...
    void holdingSchedulerTest3() throws Exception {
        ...
        AbuserDeduction holdingDeduction2 = generateAbuserDeductionByAccount(account2, abuserHistory.getLast().getId());
        ...
        holdingDeduction2.setIllegalProfit(mtAccount2.balance);
        holdingDeduction2.setIllegalProfitUsd(mtAccount2.balanceUsd);
        ...
        holdingDeduction2.setBalanceAtResolution(mtAccount2.balance);
        holdingDeduction2.setBalanceAtResolutionUsd(mtAccount2.balanceUsd);
        ...
        AbuserDeduction expectedDeduction = new AbuserDeduction(client.getUcid(), holdingDeduction2.getAbuserHistoryId(), mtAccount2.account.toString(), mtAccount2.sourceIdSt, mtAccount2.server, mtAccount2.currency, client.getBrand(), WAS_HOLDING.getDisplayName(), SENT.getDisplayName(), TO_BE_DEDUCTED.getDisplayName(), APPROVED.getDisplayName(), holdingDeduction2.getComment(), mtAccount2.balance, null, mtAccount2.balance, null, null, null, null, null, String.format("%s %s", autotestUserOne().getFirstName(), autotestUserOne().getLastName()), VINDEX_BO_SYSTEM, ILLEGAL_PROFIT.getDisplayName(), null, holdingDeduction2.getCommentDeduction(), mtAccount2.balance, null, client.getUserId().toString(), mtAccount2.balance, null, true);
        assertThat("Verify created deduction has abuser_history_id not null", wasHoldingDeduction.getAbuserHistoryId(), is(expectedDeduction.getAbuserHistoryId()));
        assertThat("Verify created deduction has illegal_profit_usd not null", wasHoldingDeduction.getIllegalProfitUsd(), notNullValue());
        assertThat("Verify created deduction has suggested_deduction_usd not null", wasHoldingDeduction.getSuggestedDeductionUsd(), notNullValue());
        assertThat("Verify created deduction has created_at not null", wasHoldingDeduction.getCreatedAt(), notNullValue());
        assertThat("Verify created deduction has updated_at not null", wasHoldingDeduction.getUpdatedAt(), notNullValue());
        ...
        expectedDeduction.setStatusDeduction(FAILED.getDisplayName());
        expectedDeduction.setActualDeduction(mtAccount2.balance);
        assertThat("Verify deduction in abuser_deduction table is as expected", deductionList.getFirst(), is(expectedDeduction));
        ...
        AccountDeductionRequest expectedKafkaDeductionRequest = new AccountDeductionRequest(null, null, mtAccount2.sourceIdSt, mtAccount2.account, "BALANCE", mtAccount2.currency, mtAccount2.balance * -1, "Cash Adjustment-PNL");
