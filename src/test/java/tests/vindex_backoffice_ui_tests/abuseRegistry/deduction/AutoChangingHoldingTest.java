...
class AutoChangingHoldingTest extends TestBaseWeb {
    ...
    void holdingSchedulerTest1() throws Exception {
        ...
        holdingDeduction1.setIllegalProfit((trade1.getProfit() + tradeWithdrawal.getProfit()) - tradeWithdrawal.getProfit());
        ...
        AbuserDeduction deduction1 = new AbuserDeduction(client.getUcid(), holdingDeduction1.getAbuserHistoryId(), mtAccount1.account.toString(), mtAccount1.sourceIdSt, mtAccount1.server, mtAccount1.currency, client.getBrand(), WAS_HOLDING.getDisplayName(), NOT_SENT.getDisplayName(), TO_BE_DEDUCTED.getDisplayName(), AWAITING_APPROVAL.getDisplayName(), holdingDeduction1.getComment(), (trade1.getProfit() + tradeWithdrawal.getProfit()) - tradeWithdrawal.getProfit(), null, trade1.getProfit() + tradeWithdrawal.getProfit(), null, null, null, null, null, String.format("%s %s", autotestUserOne().getFirstName(), autotestUserOne().getLastName()), VINDEX_BO_SYSTEM, ILLEGAL_PROFIT.getDisplayName(), null, holdingDeduction1.getCommentDeduction(), trade1.getProfit() + tradeWithdrawal.getProfit(), null, client.getUserId().toString(), trade1.getProfit() + tradeWithdrawal.getProfit(), null, false, FULL_DEDUCTION.getDisplayName());
        AbuserDeduction deduction2 = new AbuserDeduction(client.getUcid(), holdingDeduction1.getAbuserHistoryId(), mtAccount5.account.toString(), mtAccount5.sourceIdSt, mtAccount5.server, mtAccount5.currency, client.getBrand(), NOT_HOLDING.getDisplayName(), NOT_SENT.getDisplayName(), TO_BE_DEDUCTED.getDisplayName(), AWAITING_APPROVAL.getDisplayName(), holdingDeduction1.getComment(), 0d, null, trade5.getProfit(), null, null, null, null, null, String.format("%s %s", autotestUserOne().getFirstName(), autotestUserOne().getLastName()), VINDEX_BO_SYSTEM, NO_ILLEGAL_PROFIT.getDisplayName(), null, holdingDeduction1.getCommentDeduction(), trade5.getProfit(), null, client.getUserId().toString(), null, null, false, FULL_DEDUCTION.getDisplayName());
        AbuserDeduction deduction3 = new AbuserDeduction(client.getUcid(), holdingDeduction1.getAbuserHistoryId(), mtAccount4.account.toString(), mtAccount4.sourceIdSt, mtAccount4.server, mtAccount4.currency, client.getBrand(), NOT_HOLDING.getDisplayName(), NOT_SENT.getDisplayName(), TO_BE_DEDUCTED.getDisplayName(), AWAITING_APPROVAL.getDisplayName(), holdingDeduction1.getComment(), 0d, null, trade4.getProfit(), null, null, null, null, null, String.format("%s %s", autotestUserOne().getFirstName(), autotestUserOne().getLastName()), VINDEX_BO_SYSTEM, NO_ILLEGAL_PROFIT.getDisplayName(), null, holdingDeduction1.getCommentDeduction(), trade4.getProfit(), null, client.getUserId().toString(), null, null, false, FULL_DEDUCTION.getDisplayName());
        AbuserDeduction deduction5 = new AbuserDeduction(client.getUcid(), holdingDeduction1.getAbuserHistoryId(), mtAccount2.account.toString(), mtAccount2.sourceIdSt, mtAccount2.server, mtAccount2.currency, client.getBrand(), NOT_HOLDING.getDisplayName(), NOT_SENT.getDisplayName(), TO_BE_DEDUCTED.getDisplayName(), AWAITING_APPROVAL.getDisplayName(), holdingDeduction1.getComment(), 0d, null, trade2.getProfit(), null, null, null, null, null, String.format("%s %s", autotestUserOne().getFirstName(), autotestUserOne().getLastName()), VINDEX_BO_SYSTEM, NO_ILLEGAL_PROFIT.getDisplayName(), null, holdingDeduction1.getCommentDeduction(), trade2.getProfit(), null, client.getUserId().toString(), null, null, false, FULL_DEDUCTION.getDisplayName());
    ...
    void holdingSchedulerTest2() throws Exception {
        ...
        AbuserDeduction deduction3 = new AbuserDeduction(client.getUcid(), holdingDeduction1.getAbuserHistoryId(), mtAccount4.account.toString(), mtAccount4.sourceIdSt, mtAccount4.server, mtAccount4.currency, client.getBrand(), NOT_HOLDING.getDisplayName(), NOT_SENT.getDisplayName(), TO_BE_DEDUCTED.getDisplayName(), AWAITING_APPROVAL.getDisplayName(), holdingDeduction1.getComment(), 0d, null, trade4.getProfit(), null, null, null, null, null, String.format("%s %s", autotestUserOne().getFirstName(), autotestUserOne().getLastName()), VINDEX_BO_SYSTEM, NO_ILLEGAL_PROFIT.getDisplayName(), null, holdingDeduction1.getCommentDeduction(), trade4.getProfit(), null, client.getUserId().toString(), null, null, false, FULL_DEDUCTION.getDisplayName());
        AbuserDeduction deduction5 = new AbuserDeduction(client.getUcid(), holdingDeduction1.getAbuserHistoryId(), mtAccount2.account.toString(), mtAccount2.sourceIdSt, mtAccount2.server, mtAccount2.currency, client.getBrand(), NOT_HOLDING.getDisplayName(), NOT_SENT.getDisplayName(), TO_BE_DEDUCTED.getDisplayName(), AWAITING_APPROVAL.getDisplayName(), holdingDeduction1.getComment(), 0d, null, trade2.getProfit(), null, null, null, null, null, String.format("%s %s", autotestUserOne().getFirstName(), autotestUserOne().getLastName()), VINDEX_BO_SYSTEM, NO_ILLEGAL_PROFIT.getDisplayName(), null, holdingDeduction1.getCommentDeduction(), trade2.getProfit(), null, client.getUserId().toString(), null, null, false, FULL_DEDUCTION.getDisplayName());
        AbuserDeduction deduction4 = new AbuserDeduction(client.getUcid(), holdingDeduction1.getAbuserHistoryId(), mtAccount3.account.toString(), mtAccount3.sourceIdSt, mtAccount3.server, mtAccount3.currency, client.getBrand(), WAS_HOLDING.getDisplayName(), NOT_SENT.getDisplayName(), TO_BE_DEDUCTED.getDisplayName(), AWAITING_APPROVAL.getDisplayName(), holdingDeduction1.getComment(), 0d, null, trade3.getProfit(), null, null, null, null, null, String.format("%s %s", autotestUserOne().getFirstName(), autotestUserOne().getLastName()), VINDEX_BO_SYSTEM, NO_ILLEGAL_PROFIT.getDisplayName(), null, holdingDeduction1.getCommentDeduction(), trade3.getProfit(), null, client.getUserId().toString(), null, null, false, FULL_DEDUCTION.getDisplayName());
        assertThat("Verify deductions in abuser_deduction table are as expected", deductionList, containsInAnyOrder(deduction1, deduction2, deduction3, deduction4, deduction5));
    }
    ...
    void holdingSchedulerTest3() throws Exception {
        ...
        AbuserDeduction expectedDeduction1 = new AbuserDeduction(client.getUcid(), holdingDeduction2.getAbuserHistoryId(), mtAccount2.account.toString(), mtAccount2.sourceIdSt, mtAccount2.server, mtAccount2.currency, client.getBrand(), WAS_HOLDING.getDisplayName(), SENT.getDisplayName(), TO_BE_DEDUCTED.getDisplayName(), APPROVED.getDisplayName(), holdingDeduction2.getComment(), trade2.getProfit(), null, trade2.getProfit(), null, null, null, null, null, String.format("%s %s", autotestUserOne().getFirstName(), autotestUserOne().getLastName()), VINDEX_BO_SYSTEM, ILLEGAL_PROFIT.getDisplayName(), null, holdingDeduction2.getCommentDeduction(), trade2.getProfit(), null, client.getUserId().toString(), trade2.getProfit(), null, true, FULL_DEDUCTION.getDisplayName());
        AbuserDeduction expectedDeduction2 = new AbuserDeduction(client.getUcid(), holdingDeduction2.getAbuserHistoryId(), mtAccount2.account.toString(), mtAccount2.sourceIdSt, mtAccount2.server, mtAccount2.currency, client.getBrand(), WAS_HOLDING.getDisplayName(), SENT.getDisplayName(), TO_BE_DEDUCTED.getDisplayName(), APPROVED.getDisplayName(), holdingDeduction2.getComment(), trade2.getProfit(), null, trade2.getProfit(), null, null, null, null, null, String.format("%s %s", autotestUserOne().getFirstName(), autotestUserOne().getLastName()), VINDEX_BO_SYSTEM, ILLEGAL_PROFIT.getDisplayName(), null, holdingDeduction2.getCommentDeduction(), trade2.getProfit(), null, client.getUserId().toString(), trade2.getProfit(), null, true, FULL_DEDUCTION.getDisplayName());
        assertThat("Verify created deduction has abuser_history_id not null", wasHoldingDeduction.getAbuserHistoryId(), is(expectedDeduction1.getAbuserHistoryId()));
        ...
        assertThat("Verify deduction in abuser_deduction table is as expected", wasHoldingDeduction, anyOf(is(expectedDeduction1), is(expectedDeduction2)));
        ...
        AccountDeductionRequest expectedKafkaDeductionRequest = new AccountDeductionRequest(null, null, mtAccount2.sourceIdSt, mtAccount2.account, "BALANCE", mtAccount2.currency, trade2.getProfit() * -1, "Cash Adjustment-PNL");
