...
public class DeductionRecalculateTest extends TestBaseWeb {
    ...
    void teardown() throws Exception {
        ...
        deleteEntryFromDb(MT4_TRADES_COERCED_TABLE_NAME, String.format("ucid = '%s'", mtMt4TradesCoercedObject.getUcid()));
        deleteEntryFromDb(MT4_TRADES_COERCED_TABLE_NAME, String.format("ucid = '%s'", mtMt4TradesCoercedObject2.getUcid()));
    ...
    void userCanSaveDeduction() throws Exception {
        ...
        assertEquals(mtMt4TradesCoercedObject.getProfit() + mtMt4TradesCoercedObject.getStorage() + mtMt4TradesCoercedObject.getCommission(), deductionAfterRecalculation.getIllegalProfit());
        assertEquals(mtMt4TradesCoercedObject.getProfit() + mtMt4TradesCoercedObject.getStorage() + mtMt4TradesCoercedObject.getCommission(), deductionAfterRecalculation.getSuggestedDeduction());
    }
}