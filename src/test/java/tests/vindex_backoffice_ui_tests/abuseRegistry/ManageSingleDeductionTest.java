...
@Disabled("prototipe for test purpoces")
...
public class ManageSingleDeductionTest extends TestBaseWeb {
    ...
    void create1() throws Exception {
        //Vantage, not gap only, first time, gap_illegal_profit_total < 0, expecting groupLabel = "Vantage GS & Not only Gap trades & First time & GAP PNL < 0"

        final DecimalFormat formatter = new DecimalFormat("#,###.##");
        final String CURRENCY_USD = "USD";
