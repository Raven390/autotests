...
public class TradingSummaryPerformanceOverviewTest extends TestBaseWeb {
    ...
    public static void setup() throws ReflectiveOperationException, SQLException, JsonProcessingException {
        ...
        trade1.setProfitUsd(1056d);
        trade1.setStorageUsd(256d);
        trade1.setCommissionUsd(111.33d);
        trade2.setSymbol("USDEUR");
        trade2.setProfitUsd(0d);
        trade2.setStorageUsd(0d);
        trade2.setCommissionUsd(0d);
        trade3.setSymbol("USDEUR");
        trade3.setProfitUsd(-11.45d);
        trade3.setStorageUsd(0d);
        trade3.setCommissionUsd(-96.4d);
        trade3.setOpenTime(getCurrentTimestampMinusOffsetFormatted(DATE_AND_TIME, 0, 0, 0, 0, 5));
        trade4.setSymbol("EURUSD");
        trade4.setProfitUsd(0d);
        trade4.setStorageUsd(0d);
        trade4.setCommissionUsd(0d);
        trade5.setSymbol("EURUSD");
        trade5.setProfitUsd(0d);
        trade5.setStorageUsd(0d);
        trade5.setCommissionUsd(0d);
        trade6.setSymbol("EURUSD");
        trade6.setProfitUsd(0d);
        trade6.setStorageUsd(0d);
        trade6.setCommissionUsd(0d);
        trade7.setSymbol("GBPJPY");
        trade7.setProfitUsd(1056d);
        trade7.setStorageUsd(256d);
        trade7.setCommissionUsd(111.33d);
        trade7.setOpenTime(getCurrentTimestampMinusOffsetFormatted(DATE_AND_TIME, 0, 0, 0, 0, 5));
        trade8.setSymbol("GBPJPY");
        trade8.setProfitUsd(1056d);
        trade8.setStorageUsd(256d);
        trade8.setCommissionUsd(11.33d);
        trade8.setOpenTime(getCurrentTimestampMinusOffsetFormatted(DATE_AND_TIME, 0, 0, 0, 0, 5));
        trade9.setSymbol("GBPJPY");
        trade9.setProfitUsd(1056d);
        trade9.setStorageUsd(256d);
        trade9.setCommissionUsd(111.33d);
        trade9.setOpenTime(getCurrentTimestampMinusOffsetFormatted(DATE_AND_TIME, 0, 0, 0, 0, 5));
        trade10.setSymbol("AEDCZK");
        trade10.setProfitUsd(-1056d);
        trade10.setStorageUsd(-256d);
        trade10.setCommissionUsd(-111.33d);
        trade11.setSymbol("CZKAED");
        trade12.setSymbol("HRKEUR");
        trade12.setProfitUsd(-11_056d);
        trade12.setStorageUsd(-85_256d);
        trade12.setCommissionUsd(-111.33d);
        crmTbUser.registrationDate = transformDate(trade9.getOpenTime(), DATE_AND_TIME, DATE);
