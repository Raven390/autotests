...
public class TradingSummaryTotalPnlTest extends TestBaseWeb {
    ...
    public static void setup() throws ReflectiveOperationException, SQLException, JsonProcessingException {
        trade8.setProfitUsd(2854.345);
        trade8.setStorageUsd(0d);
        trade8.setCommissionUsd(0d);
        trade8.setCloseTime(getCurrentTimestampMinusOffsetFormatted(DATE_AND_TIME, 0, 0, 8, 0, 0));
        trade7.setProfitUsd(-884.243);
        trade7.setStorageUsd(0d);
        trade7.setCommissionUsd(0d);
        trade7.setCloseTime(getCurrentTimestampMinusOffsetFormatted(DATE_AND_TIME, 0, 0, 7, 0, 0));
        trade6.setProfitUsd(-4224.867);
        ...
        trade2.setProfitUsd(-10_212.975);
    ...
    public void verifyTradingSummaryTotalPnlTest() {
        ...
        String maxProfitDate = transformDate(trade3.getCloseTime(), DATE_AND_TIME, DAY_SHORT_MONTH_YEAR);
        String maxLossDate = transformDate(trade2.getCloseTime(), DATE_AND_TIME, DAY_SHORT_MONTH_YEAR);
