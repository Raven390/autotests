...
public class CpaOverviewSummaryTest extends TestBaseWeb {
    ...
    public static void teardown() throws Exception {
        ...
        deleteObjectFromDb(CLIENT_FRAUD_TYPES_TABLE_NAME, String.format("ucid = '%s'", client.getUcid()));
        deleteObjectFromDb(S3_FACT_CPA_COMMISSIONS, String.format("ucid = '%s'", client.getUcid()));
    }
}
