...
class PaymentsSummaryPanelTest extends TestBaseWeb {
    ...
    @BeforeAll
    static void setup() {
        insertObjectsToDb(CRM_USER_TABLE_NAME, List.of(crmTbUser, crmTbUserBybit, crmTbUserRebatesParent, crmTbUserRebatesChild));
        ...
        insertObjectsToDb(MT_ACCOUNT_TABLE_NAME, List.of(mtAccount, mtAccountBybit, mtAccountRebates, mtAccountRebatesParent, mtAccountRebatesChild));
    }
    ...
    void paymentsSummaryDepositsPanelTest() {
        ...
        MtBalanceOrdersObject deposit4 = generateMtBalanceOrder(client, getRandomRoundedDouble(0.01, 99_999.99), getRandomRoundedDouble(0.01, 99_999.99), getCurrentTimestampDbFormat());
        deposit4.setComment("123 transfer in 456");
        MtBalanceOrdersObject deposit5 = generateMtBalanceOrder(client, getRandomRoundedDouble(0.01, 99_999.99), getRandomRoundedDouble(0.01, 99_999.99), getCurrentTimestampDbFormat());
        deposit5.setComment("123 transfer in 456");
        MtBalanceOrdersObject deposit6 = generateMtBalanceOrder(client, getRandomRoundedDouble(-99_999.99, -0.01), getRandomRoundedDouble(-99_999.99, -0.01), getCurrentTimestampDbFormat());
        deposit6.setComment("123 transfer in 456");
        MtBalanceOrdersObject deposit7 = generateMtBalanceOrder(client, getRandomRoundedDouble(0.01, 99_999.99), getRandomRoundedDouble(0.01, 99_999.99), getCurrentTimestampDbFormat());
        deposit7.setComment("non standard");
        MtBalanceOrdersObject deposit8 = generateMtBalanceOrder(client, getRandomRoundedDouble(0.01, 99_999.99), getRandomRoundedDouble(0.01, 99_999.99), getCurrentTimestampDbFormat());
        deposit8.setComment("non standard");
        MtBalanceOrdersObject deposit9 = generateMtBalanceOrder(client, getRandomRoundedDouble(-99_999.99, -0.01), getRandomRoundedDouble(-99_999.99, -0.01), getCurrentTimestampDbFormat());
        deposit9.setComment("non standard");
        //withdrawals
        MtBalanceOrdersObject withdrawal1 = generateMtBalanceOrder(client, getRandomRoundedDouble(-99_999.99, -0.01), getRandomRoundedDouble(-99_999.99, -0.01), getCurrentTimestampDbFormat());
        withdrawal1.setComment("123 withdraw 456");
        insertObjectsToDb(MT_BALANCE_ORDERS_TABLE_NAME, List.of(deposit1, deposit2, deposit3, deposit4, deposit5, deposit6, deposit7, deposit8, deposit9, withdrawal1));
        ...
        paymentsPage.verifyPaymentSummaryPanelValue("Deposits", "Deposit amount", decimalFormat.format(roundDouble(deposit1.amountUsd + deposit2.amountUsd, 2)) + " USD");
        paymentsPage.verifyPaymentSummaryPanelValue("Deposits", "Net deposits", decimalFormat.format(roundDouble(deposit1.amountUsd + deposit2.amountUsd - crmTbWithdrawal1.getAmountUsd().doubleValue() - crmTbWithdrawal2.getAmountUsd().doubleValue(), 2)) + " USD");
        paymentsPage.verifyPaymentSummaryPanelValue("Deposits", "Internal transfers in", decimalFormat.format(roundDouble(deposit4.amountUsd + deposit5.amountUsd, 2)) + " USD");
        paymentsPage.verifyPaymentSummaryPanelValue("Deposits", "Positive adjustments", decimalFormat.format(roundDouble(deposit3.amountUsd + deposit7.amountUsd + deposit8.amountUsd, 2)) + " USD");
        paymentsPage.verifyPaymentSummaryPanelValue("Deposits", "Total amount in", decimalFormat.format(roundDouble(deposit1.amountUsd + deposit2.amountUsd + deposit3.amountUsd + deposit4.amountUsd + deposit5.amountUsd + deposit7.amountUsd + deposit8.amountUsd, 2)) + " USD");
    }
    ...
    void paymentsSummaryWithdrawalsPanelTest() {
        ...
        MtBalanceOrdersObject withdrawal1 = generateMtBalanceOrder(client, getRandomRoundedDouble(-99_999.99, -0.01), getRandomRoundedDouble(-99_999.99, -0.01), getCurrentTimestampDbFormat());
        withdrawal1.setComment("123 withdraw 456");
        MtBalanceOrdersObject withdrawal2 = generateMtBalanceOrder(client, getRandomRoundedDouble(-99_999.99, -0.01), getRandomRoundedDouble(-99_999.99, -0.01), getCurrentTimestampDbFormat());
        withdrawal2.setComment("123 withdraw 456");
        MtBalanceOrdersObject withdrawal3 = generateMtBalanceOrder(client, getRandomRoundedDouble(-99_999.99, -0.01), getRandomRoundedDouble(-99_999.99, -0.01), getCurrentTimestampDbFormat());
        withdrawal3.setComment("123 pam 456");
        MtBalanceOrdersObject withdrawal4 = generateMtBalanceOrder(client, getRandomRoundedDouble(-99_999.99, -0.01), getRandomRoundedDouble(-99_999.99, -0.01), getCurrentTimestampDbFormat());
        withdrawal4.setComment("123 rebat 456");
        MtBalanceOrdersObject withdrawal5 = generateMtBalanceOrder(client, getRandomRoundedDouble(-99_999.99, -0.01), getRandomRoundedDouble(-99_999.99, -0.01), getCurrentTimestampDbFormat());
        withdrawal5.setComment("123 back 456");
        MtBalanceOrdersObject withdrawal6 = generateMtBalanceOrder(client, getRandomRoundedDouble(-99_999.99, -0.01), getRandomRoundedDouble(-99_999.99, -0.01), getCurrentTimestampDbFormat());
        withdrawal6.setComment("123 transfer out 456");
        MtBalanceOrdersObject withdrawal7 = generateMtBalanceOrder(client, getRandomRoundedDouble(-99_999.99, -0.01), getRandomRoundedDouble(-99_999.99, -0.01), getCurrentTimestampDbFormat());
        withdrawal7.setComment("123 transfer out 456");
        MtBalanceOrdersObject withdrawal8 = generateMtBalanceOrder(client, getRandomRoundedDouble(0.01, 99_999.99), getRandomRoundedDouble(0.01, 99_999.99), getCurrentTimestampDbFormat());
        withdrawal8.setComment("123 transfer out 456");
        MtBalanceOrdersObject withdrawal9 = generateMtBalanceOrder(client, getRandomRoundedDouble(-99_999.99, -0.01), getRandomRoundedDouble(-99_999.99, -0.01), getCurrentTimestampDbFormat());
        withdrawal9.setComment("non standard");
        MtBalanceOrdersObject withdrawal10 = generateMtBalanceOrder(client, getRandomRoundedDouble(-99_999.99, -0.01), getRandomRoundedDouble(-99_999.99, -0.01), getCurrentTimestampDbFormat());
        withdrawal10.setComment("non standard");
        MtBalanceOrdersObject withdrawal11 = generateMtBalanceOrder(client, getRandomRoundedDouble(0.01, 99_999.99), getRandomRoundedDouble(0.01, 99_999.99), getCurrentTimestampDbFormat());
        ...
        crmTbWithdrawal2.setStatusId(16);
        crmTbWithdrawal2.setStatusGroup("Success");
        insertObjectsToDb(MT_BALANCE_ORDERS_TABLE_NAME, List.of(withdrawal1, withdrawal2, withdrawal3, withdrawal4, withdrawal5, withdrawal6, withdrawal7, withdrawal8, withdrawal9, withdrawal10, withdrawal11, deposit1));
        insertObjectsToDb(CLICKHOUSE_CRM_TB_WITHDRAWAL, List.of(crmTbWithdrawal1, crmTbWithdrawal2));
        ...
        paymentsPage.verifyPaymentSummaryPanelValue("Withdrawals", "Withdrawal amount", decimalFormat.format(Math.abs(roundDouble(crmTbWithdrawal1.getAmountUsd().doubleValue() + crmTbWithdrawal2.getAmountUsd().doubleValue(), 2))) + " USD");
        paymentsPage.verifyPaymentSummaryPanelValue("Withdrawals", "Net withdrawals", decimalFormat.format(roundDouble(Math.abs(crmTbWithdrawal1.getAmountUsd().doubleValue() + crmTbWithdrawal2.getAmountUsd().doubleValue()) - deposit1.amountUsd, 2)) + " USD");
        paymentsPage.verifyPaymentSummaryPanelValue("Withdrawals", "Internal transfers out", decimalFormat.format(Math.abs(roundDouble(withdrawal6.amountUsd + withdrawal7.amountUsd, 2))) + " USD");
        paymentsPage.verifyPaymentSummaryPanelValue("Withdrawals", "Negative adjustments", decimalFormat.format(Math.abs(roundDouble(withdrawal3.amountUsd + withdrawal9.amountUsd + withdrawal10.amountUsd + withdrawal5.amountUsd, 2))) + " USD");
        paymentsPage.verifyPaymentSummaryPanelValue("Withdrawals", "Total amount out", decimalFormat.format(Math.abs(roundDouble(-1 * (-crmTbWithdrawal1.getAmountUsd().doubleValue() - crmTbWithdrawal2.getAmountUsd().doubleValue() + withdrawal3.amountUsd + withdrawal5.amountUsd + withdrawal6.amountUsd + withdrawal7.amountUsd + withdrawal9.amountUsd + withdrawal10.amountUsd), 2))) + " USD");
    }
    ...
    void paymentsSummaryTradingPanelTest() {
        ...
        paymentsPage.verifyPaymentSummaryPanelValue("Trading", "Lots traded", decimalFormat.format(roundDouble(trade3.getVolumeLots() + trade4.getVolumeLots(), 2)) + " lots");
        paymentsPage.verifyPaymentSummaryPanelValue("Trading", "Volume", decimalFormat.format(roundDouble(trade3.getNotionalValueUsd() + trade4.getNotionalValueUsd(), 2)) + " USD");
        paymentsPage.verifyPaymentSummaryPanelValue("Trading", "Equity", decimalFormat.format(roundDouble(account.equity + accountRebates.equity, 2)) + " USD");
    ...
    void paymentsSummaryPNLPanelTest() {
        ...
        paymentsPage.verifyPaymentSummaryPanelValue("PNL", "Profit", decimalFormat.format(roundDouble(trade1.getProfitUsd() + trade2.getProfitUsd(), 2)) + " USD");
        paymentsPage.verifyPaymentSummaryPanelValue("PNL", "Realized PNL", decimalFormat.format(roundDouble(trade1.getProfitUsd() + trade2.getProfitUsd() + trade1.getStorageUsd() + trade2.getStorage() + trade1.getCommissionUsd() + trade2.getCommissionUsd(), 2)) + " USD");
        paymentsPage.verifyPaymentSummaryPanelValue("PNL", "Floating PNL", decimalFormat.format(roundDouble(mtAccount.floatingPnlUsd + mtAccountRebates.floatingPnlUsd, 2)) + " USD");
        paymentsPage.verifyPaymentSummaryPanelValue("PNL", "Trading PNL", decimalFormat.format(roundDouble(mtAccount.floatingPnlUsd + mtAccountRebates.floatingPnlUsd + trade1.getProfitUsd() + trade2.getProfitUsd() + trade1.getStorageUsd() + trade2.getStorage() + trade1.getCommissionUsd() + trade2.getCommissionUsd(), 2)) + " USD");
        //no positive or negative adjustments inserted
        paymentsPage.verifyPaymentSummaryPanelValue("PNL", "Gross PNL", decimalFormat.format(roundDouble(mtAccount.floatingPnlUsd + mtAccountRebates.floatingPnlUsd + trade1.getProfitUsd() + trade2.getProfitUsd() + trade1.getStorageUsd() + trade2.getStorage() + trade1.getCommissionUsd() + trade2.getCommissionUsd(), 2)) + " USD");
        //no ib rebates, sales commissions, cpa rebates inserted
        paymentsPage.verifyPaymentSummaryPanelValue("PNL", "Net client PNL", decimalFormat.format(roundDouble(mtAccount.floatingPnlUsd + mtAccountRebates.floatingPnlUsd + trade1.getProfitUsd() + trade2.getProfitUsd() + trade1.getStorageUsd() + trade2.getStorage() + trade1.getCommissionUsd() + trade2.getCommissionUsd(), 2)) + " USD");
    }
    ...
    void paymentsSummaryVWalletPanelTest() {
        ...
        insertObjectsToDb(CRM_WALLET_TRADE_ORDER_TABLE, List.of(wallerOrder1, wallerOrder2, wallerOrder3, wallerOrder4));
        investigationPage.navigateEnterPage();
        keycloackPage.loginAsAutotestUser();
        paymentsPage.navigatePaymentsTab(client.getUcid());

        paymentsPage.verifyPaymentSummaryPanelValue("V-wallet", "Balance", decimalFormat.format(roundDouble(wallerOrder3.getToAmount().doubleValue() - wallerOrder1.getFromAmount().doubleValue() - wallerOrder2.getFromAmount().doubleValue() - wallerOrder4.getFromAmount().doubleValue(), 2)) + " USD");
        paymentsPage.verifyPaymentSummaryPanelValue("V-wallet", "MT to V-wallet", decimalFormat.format(roundDouble(wallerOrder3.getToAmountUsd().doubleValue(), 2)) + " USD");
        paymentsPage.verifyPaymentSummaryPanelValue("V-wallet", "V-wallet to MT", decimalFormat.format(roundDouble(wallerOrder2.getFromAmountUsd().doubleValue(), 2)) + " USD");
        paymentsPage.verifyPaymentSummaryPanelValue("V-wallet", "Client to V-wallet", decimalFormat.format(roundDouble(wallerOrder1.getToAmountUsd().doubleValue(), 2)) + " USD");
        paymentsPage.verifyPaymentSummaryPanelValue("V-wallet", "V-wallet to Client", decimalFormat.format(roundDouble(wallerOrder4.getFromAmountUsd().doubleValue(), 2)) + " USD");
    }
    ...
    void paymentsSummaryCostEfficiencyPanelTest() {
        ...
        paymentsPage.verifyPaymentSummaryPanelValue("Cost efficiency", "Spread revenue", decimalFormat.format(roundDouble(historyMetrics.getDailyCoreSpreadRevenuePe() + historyMetrics.getDailyCoreSpreadRevenueOz(), 2)) + " USD");
        paymentsPage.verifyPaymentSummaryPanelValue("Cost efficiency", "Company RFR", decimalFormat.format(roundDouble(historyMetrics.getDailyCoreSpreadRevenuePe() + historyMetrics.getDailyCoreSpreadRevenueOz() - historyMetrics.getIbCommission(), 2)) + " USD");
        paymentsPage.verifyExistingPaymentSummaryPanelValue("Cost efficiency", "Payments cost");
        paymentsPage.verifyPaymentSummaryPanelValue("Cost efficiency", "Swaps", decimalFormat.format(roundDouble(mt5DealsCoerced.getStorageUsd(), 2)) + " USD");
        paymentsPage.verifyPaymentSummaryPanelValue("Cost efficiency", "Commissions", decimalFormat.format(roundDouble(mt5DealsCoerced.getCommissionUsd(), 2)) + " USD");
    }
    ...
    void paymentsSummaryRewardsPanelTest() {
        ...
        paymentsPage.verifyPaymentSummaryPanelValue("Rewards", "Credits in", decimalFormat.format(roundDouble(credit.amountUsd, 2)) + " USD");
        paymentsPage.verifyPaymentSummaryPanelValue("Rewards", "IB rebates", decimalFormat.format(roundDouble(historyMetrics.getIbCommission(), 2)) + " USD");
        paymentsPage.verifyPaymentSummaryPanelValue("Rewards", "Sales commissions", decimalFormat.format(roundDouble(historyMetrics.getSalesCommission(), 2)) + " USD");
        paymentsPage.verifyPaymentSummaryPanelValue("Rewards", "CPA commissions", decimalFormat.format(roundDouble(cpaCommission.getCommission(), 2)) + " USD");
    }
    ...
    void paymentsSummaryIBRebatesPanelTest() {
        ...
        AccountIbRelationSnapshotObject ibRelationReceivedFromIB = generateAccountIbRelationSnapshotObjectByAccounts(accountRebates, accountRebatesParent);
        ...
        AccountIbRelationSnapshotObject ibRelationSentToClients = generateAccountIbRelationSnapshotObjectByAccounts(accountRebatesChild, accountRebates);
        insertObjectsToDb(MT_BALANCE_ORDERS_TABLE_NAME, List.of(balanceOrderEarnedAsIb, balanceOrderInternalTransferIn, balanceOrderInternalTransferOut, balanceOrderReceivedFromIb, balanceOrderSentToClients));
        insertObjectsToDb(ACCOUNT_IB_RELATION_SNAPSHOT_TABLE_NAME, List.of(ibRelationReceivedFromIB, ibRelationSentToClients));

        investigationPage.navigateEnterPage();
        keycloackPage.loginAsAutotestUser();
        paymentsPage.navigatePaymentsTab(client.getUcid());

        paymentsPage.verifyPaymentSummaryPanelValue("IB rebates", "Earned as IB", decimalFormat.format(roundDouble(balanceOrderEarnedAsIb.getAmountUsd(), 2)) + " USD");
        paymentsPage.verifyPaymentSummaryPanelValue("IB rebates", "Internal transfer in", decimalFormat.format(roundDouble(balanceOrderInternalTransferIn.getAmountUsd(), 2)) + " USD");
        paymentsPage.verifyPaymentSummaryPanelValue("IB rebates", "Internal transfer out", decimalFormat.format(roundDouble(-balanceOrderInternalTransferOut.getAmountUsd(), 2)) + " USD");
        paymentsPage.verifyPaymentSummaryPanelValue("IB rebates", "Received from IB", decimalFormat.format(roundDouble(balanceOrderReceivedFromIb.getAmountUsd(), 2)) + " USD");
        paymentsPage.verifyPaymentSummaryPanelValue("IB rebates", "Sent to clients", decimalFormat.format(roundDouble(-balanceOrderSentToClients.getAmountUsd(), 2)) + " USD");
    }
}
