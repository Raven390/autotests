...
public class CpaAbuseRuleTests extends TestBaseRule {
    ...
    @AllureId("916")
    public void cpaRuleExitEventEnd1Test() throws Exception {
    ...
    @AllureId("917")
    public void cpaRuleExitEventEnd2_1Test() throws Exception {
...
//        List<ClientsRestriction> clientsRestrictions = getObjectsFromDB(DbName.MITIGATION_POSTGRES, MITIGATION_CLIENTS_RESTRICTION, String.format("ucid = '%s'", data.clientHelper.getUcid()), ClientsRestriction.class);
    ...
    @AllureId("921")
    public void cpaRuleExitEventEnd2_2Test() throws Exception {
...
//        List<ClientsRestriction> clientsRestrictions = getObjectsFromDB(DbName.MITIGATION_POSTGRES, MITIGATION_CLIENTS_RESTRICTION, String.format("ucid = '%s'", data.clientHelper.getUcid()), ClientsRestriction.class);
    ...
    @AllureId("929")
    public void cpaRuleExitEventEnd3Test() throws Exception {
    ...
    @AllureId("929")
    public void cpaRuleExitEventEnd4_1Test() throws Exception {
    ...
    @AllureId("929")
    public void cpaRuleExitEventEnd4_2Test() throws Exception {
...
//        assertThat("Verify that the restriction is as expected", restriction, equalTo(expectedRestriction));
    ...
    @AllureId("929")
    public void cpaRuleExitEventEnd4_3Test() throws Exception {
