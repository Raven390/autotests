...
import static helpers.data.rules.nbpWinningLegRule.NbpWinningLegRuleDataFactory.deleteNbpWinningLegRuleData;
import static helpers.data.rules.nbpWinningLegRule.NbpWinningLegRuleDataFactory.setupNbpWinningLegRuleData;
...
public class NbpWinningLegRuleTest extends TestBaseRule {
    ...
    public void nbpWinningLegEnd1Test() throws Exception {
        ...
        List<String> reasons = clientsRestrictions.stream().map(restriction -> restriction.applicationReason).collect(Collectors.toList());
    ...
    public void nbpWinningLegEnd3Test() throws Exception {
        ...
        ClientsRestriction expectedRestriction = new ClientsRestriction(data.clientHelper.getUcid(), data.crmTbUserObject.regulator, 8L, "NBP_set_restriction", "APPLIED");
