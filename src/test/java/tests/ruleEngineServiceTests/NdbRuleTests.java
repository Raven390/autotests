...
import static helpers.data.rules.RulesAssertHelper.*;
import static helpers.data.rules.ndbRule.NdbRuleDataFactory.deleteNdbRuleData;
import static helpers.data.rules.ndbRule.NdbRuleDataFactory.setupNdbRuleData;
...
public class NdbRuleTests extends TestBaseRule {
    ...
    public void ndbRuleExitEventEnd1Test() throws Exception {
        ...
        asserAlertsAmountByClient(data.clientHelper, 0);
        assertRestrictionsAmountByClient(data.clientHelper, 0);
    }
