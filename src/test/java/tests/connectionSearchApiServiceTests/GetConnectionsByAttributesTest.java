...
import businessObjects.db.csTbDocTable.DocumentTableEntry;
import businessObjects.db.csTbEmailTable.EmailTableEntry;
import businessObjects.db.csTbIpTable.IpTableEntry;
import businessObjects.db.csTbPayoutTable.PayoutTableEntry;
import businessObjects.db.csTbPhoneTable.PhoneTableEntry;
...
import static businessObjects.db.csTbConnectionTableV2.ConnectionTableEntryFactory.*;
import static businessObjects.db.csTbDocTable.DocumentTableEntryFactory.documentTableEntryForConnectionSearch;
import static businessObjects.db.csTbEmailTable.EmailTableEntryFactory.emailTableEntryForConnectionSearch;
import static businessObjects.db.csTbIpTable.IpTableEntryFactory.ipTableEntryForConnectionSearch;
import static businessObjects.db.csTbPayoutTable.PayoutTableEntryFactory.payoutTableEntryForConnectionSearch;
import static businessObjects.db.csTbPhoneTable.PhoneTableEntryFactory.phoneTableEntryForConnectionSearch;
